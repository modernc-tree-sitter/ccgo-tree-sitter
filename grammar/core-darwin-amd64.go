// Code generated for darwin/amd64 by 'ccgo -ignore-unsupported-alignment -ignore-unsupported-atomic-sizes -ignore-vector-functions core_complete.c -o core.go', DO NOT EDIT.
...
func __sputc(tls *libc.TLS, _c int32, _p uintptr) (r int32) {
	var v1 int32
	var v2, v4, v5 uintptr
	var v3 uint8
	_, _, _, _, _ = v1, v2, v3, v4, v5
	v2 = _p + 12
	*(*int32)(unsafe.Pointer(v2)) = *(*int32)(unsafe.Pointer(v2)) - 1
	v1 = *(*int32)(unsafe.Pointer(v2))
	if v1 >= 0 || (*FILE)(unsafe.Pointer(_p)).F_w >= (*FILE)(unsafe.Pointer(_p)).F_lbfsize && int32(int8(_c)) != int32('\n') {
		v3 = libc.Uint8FromInt32(_c)
		v5 = _p
		v4 = *(*uintptr)(unsafe.Pointer(v5))
		*(*uintptr)(unsafe.Pointer(v5)) = *(*uintptr)(unsafe.Pointer(v5)) + 1
		*(*uint8)(unsafe.Pointer(v4)) = v3
		return libc.Int32FromUint8(v3)
	} else {
		return libc.X__swbuf(tls, _c, _p)
	}
	return r
}
...
func ts_malloc_default(tls *libc.TLS, size size_t) (r uintptr) {
	...
	if size > uint64(0) && !(result != 0) {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts, libc.VaList(bp+8, size))
		libc.Xabort(tls)
	}
	return result
}
...
func ts_calloc_default(tls *libc.TLS, count size_t, size size_t) (r uintptr) {
	...
	if count > uint64(0) && !(result != 0) {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts, libc.VaList(bp+8, count*size))
		libc.Xabort(tls)
	}
	return result
}
...
func ts_realloc_default(tls *libc.TLS, buffer uintptr, size size_t) (r uintptr) {
	...
	if size > uint64(0) && !(result != 0) {
		libc.Xfprintf(tls, libc.X__stderrp, __ccgo_ts+41, libc.VaList(bp+8, size))
		libc.Xabort(tls)
	}
	return result
}
...
var LENGTH_MAX = Length{
	Fbytes: uint32(4294967295),
	Fextent: TSPoint{
		Frow:    uint32(4294967295),
		Fcolumn: uint32(4294967295),
	},
}
...
func _array__erase(tls *libc.TLS, self_contents uintptr, size uintptr, element_size size_t, index uint32_t) {
	...
	_ = contents
	if libc.BoolInt64(!(index < *(*uint32_t)(unsafe.Pointer(size)))) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__)), __ccgo_ts+84, int32(199), __ccgo_ts+92)
	}
	contents = self_contents
	libc.X__builtin___memmove_chk(tls, contents+uintptr(uint64(index)*element_size), contents+uintptr(uint64(index+libc.Uint32FromInt32(1))*element_size), uint64(*(*uint32_t)(unsafe.Pointer(size))-index-libc.Uint32FromInt32(1))*element_size, ^__predefined_size_t(0))
...
func _array__assign(tls *libc.TLS, self_contents uintptr, self_size uintptr, self_capacity uintptr, other_contents uintptr, other_size uint32_t, element_size size_t) (r uintptr) {
	...
	*(*uint32_t)(unsafe.Pointer(self_size)) = other_size
	libc.X__builtin___memcpy_chk(tls, new_contents, other_contents, uint64(*(*uint32_t)(unsafe.Pointer(self_size)))*element_size, ^__predefined_size_t(0))
	return new_contents
}
...
func _array__splice(tls *libc.TLS, self_contents uintptr, size uintptr, capacity uintptr, element_size size_t, index uint32_t, old_count uint32_t, new_count uint32_t, elements uintptr) (r uintptr) {
	...
	if libc.BoolInt64(!(old_end <= *(*uint32_t)(unsafe.Pointer(size)))) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__1)), __ccgo_ts+84, int32(263), __ccgo_ts+106)
	}
	new_contents = _array__reserve(tls, self_contents, capacity, element_size, new_size)
	contents = new_contents
	if *(*uint32_t)(unsafe.Pointer(size)) > old_end {
		libc.X__builtin___memmove_chk(tls, contents+uintptr(uint64(new_end)*element_size), contents+uintptr(uint64(old_end)*element_size), uint64(*(*uint32_t)(unsafe.Pointer(size))-old_end)*element_size, ^__predefined_size_t(0))
	}
	if new_count > uint32(0) {
		if elements != 0 {
			libc.X__builtin___memcpy_chk(tls, contents+uintptr(uint64(index)*element_size), elements, uint64(new_count)*element_size, ^__predefined_size_t(0))
		} else {
			libc.X__builtin___memset_chk(tls, contents+uintptr(uint64(index)*element_size), 0, uint64(new_count)*element_size, ^__predefined_size_t(0))
		}
	}
...
func ts_tree_cursor_current_subtree(tls *libc.TLS, _self uintptr) (r Subtree) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__2)), __ccgo_ts+123, int32(42), __ccgo_ts+137)
	}
	last_entry = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_language_write_symbol_as_dot_string(tls *libc.TLS, self uintptr, f uintptr, symbol TSSymbol) {
	...
	for {
		...
		case int32('\n'):
			libc.Xfputs(tls, __ccgo_ts+197, f)
		case int32('\t'):
			libc.Xfputs(tls, __ccgo_ts+200, f)
		default:
			libc.Xfputc(tls, int32(*(*int8)(unsafe.Pointer(chr))), f)
			break
		}
...
func ts_range_array_add(tls *libc.TLS, self uintptr, start Length, end Length) {
	...
	if (*TSRangeArray)(unsafe.Pointer(self)).Fsize > uint32(0) {
		if libc.BoolInt64(!((*TSRangeArray)(unsafe.Pointer(self)).Fsize-libc.Uint32FromInt32(1) < (*TSRangeArray)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__3)), __ccgo_ts+203, int32(16), __ccgo_ts+224)
		}
...
func ts_range_array_intersects(tls *libc.TLS, self uintptr, start_index uint32, start_byte uint32_t, end_byte uint32_t) (r uint8) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*TSRangeArray)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__4)), __ccgo_ts+203, int32(37), __ccgo_ts+268)
		}
...
func ts_range_edit(tls *libc.TLS, range1 uintptr, edit uintptr) {
	if (*TSRange)(unsafe.Pointer(range1)).Fend_byte >= (*TSInputEdit)(unsafe.Pointer(edit)).Fold_end_byte {
		if (*TSRange)(unsafe.Pointer(range1)).Fend_byte != uint32(4294967295) {
			...
			if (*TSRange)(unsafe.Pointer(range1)).Fend_byte < (*TSInputEdit)(unsafe.Pointer(edit)).Fnew_end_byte {
				(*TSRange)(unsafe.Pointer(range1)).Fend_byte = uint32(4294967295)
	...
	if (*TSRange)(unsafe.Pointer(range1)).Fstart_byte >= (*TSInputEdit)(unsafe.Pointer(edit)).Fold_end_byte {
		...
		if (*TSRange)(unsafe.Pointer(range1)).Fstart_byte < (*TSInputEdit)(unsafe.Pointer(edit)).Fnew_end_byte {
			(*TSRange)(unsafe.Pointer(range1)).Fstart_byte = uint32(4294967295)
...
func iterator_start_position(tls *libc.TLS, self uintptr) (r Length) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__5)), __ccgo_ts+203, int32(174), __ccgo_ts+297)
	}
...
func iterator_end_position(tls *libc.TLS, self uintptr) (r Length) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__6)), __ccgo_ts+203, int32(183), __ccgo_ts+297)
	}
	entry = *(*TreeCursorEntry)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func iterator_tree_is_visible(tls *libc.TLS, self uintptr) (r uint8) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__7)), __ccgo_ts+203, int32(193), __ccgo_ts+297)
	}
	entry = *(*TreeCursorEntry)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	if (*Iterator)(unsafe.Pointer(self)).Fcursor.Fstack.Fsize > uint32(1) {
		*(*Subtree)(unsafe.Pointer(bp)) = Subtree{}
		if libc.BoolInt64(!((*Iterator)(unsafe.Pointer(self)).Fcursor.Fstack.Fsize-libc.Uint32FromInt32(2) < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(self+8)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__7)), __ccgo_ts+203, int32(196), __ccgo_ts+371)
		}
		*(*struct {
			Fptr  [0]uintptr
			Fdata SubtreeInlineData
...
func iterator_get_visible_state(tls *libc.TLS, self uintptr, tree uintptr, alias_symbol uintptr, start_byte uintptr) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__8)), __ccgo_ts+203, int32(220), __ccgo_ts+441)
		}
		entry = *(*TreeCursorEntry)(unsafe.Pointer((*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		if i > uint32(0) {
			if libc.BoolInt64(!(i-libc.Uint32FromInt32(1) < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+8)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__8)), __ccgo_ts+203, int32(223), __ccgo_ts+485)
			}
...
func iterator_ascend(tls *libc.TLS, self uintptr) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__9)), __ccgo_ts+203, int32(242), __ccgo_ts+297)
	}
...
func iterator_descend(tls *libc.TLS, self uintptr, goal_position uint32_t) (r uint8) {
	...
	for cond := true; cond; cond = did_descend != 0 {
		...
		if libc.BoolInt64(!((*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__10)), __ccgo_ts+203, int32(252), __ccgo_ts+297)
		}
		entry = *(*TreeCursorEntry)(unsafe.Pointer((*struct {
			Fcontents uintptr
			Fsize     uint32_t
	...
	for {
		...
		*(*uint32_t)(unsafe.Pointer(v3)) = *(*uint32_t)(unsafe.Pointer(v3)) - 1
		...
		if libc.BoolInt64(!((*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__11)), __ccgo_ts+203, int32(309), __ccgo_ts+297)
		}
		parent = (*TreeCursorEntry)(unsafe.Pointer((*struct {
			Fcontents uintptr
			Fsize     uint32_t
	...
	for cond := true; cond; cond = !(iterator_done(tls, bp+16) != 0) && !(iterator_done(tls, bp+72) != 0) {
		...
		for included_range_difference_index < (*TSRangeArray)(unsafe.Pointer(included_range_differences)).Fsize {
			if libc.BoolInt64(!(included_range_difference_index < (*TSRangeArray)(unsafe.Pointer(included_range_differences)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__12)), __ccgo_ts+203, int32(536), __ccgo_ts+533)
			}
...
func ts_language_table_entry(tls *libc.TLS, self uintptr, state TSStateId, symbol TSSymbol, result uintptr) {
	...
	if libc.Int32FromUint16(symbol) == libc.Int32FromUint16(libc.Uint16FromInt32(-libc.Int32FromInt32(1))) || libc.Int32FromUint16(symbol) == libc.Int32FromUint16(libc.Uint16FromInt32(-libc.Int32FromInt32(1)))-libc.Int32FromInt32(1) {
		...
		if libc.BoolInt64(!(uint32(symbol) < (*TSLanguage)(unsafe.Pointer(self)).Ftoken_count)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__13)), __ccgo_ts+614, int32(79), __ccgo_ts+625)
		}
...
func ts_language_symbol_name(tls *libc.TLS, self uintptr, symbol TSSymbol) (r uintptr) {
	if libc.Int32FromUint16(symbol) == libc.Int32FromUint16(libc.Uint16FromInt32(-libc.Int32FromInt32(1))) {
		return __ccgo_ts + 652
	} else {
		if libc.Int32FromUint16(symbol) == libc.Int32FromUint16(libc.Uint16FromInt32(-libc.Int32FromInt32(1)))-libc.Int32FromInt32(1) {
			return __ccgo_ts + 658
		} else {
...
func ts_language_symbol_for_name(tls *libc.TLS, self uintptr, string1 uintptr, length uint32_t, is_named uint8) (r TSSymbol) {
	...
	if is_named != 0 && !(libc.Xstrncmp(tls, string1, __ccgo_ts+652, uint64(length)) != 0) {
...
func OSReadSwapInt16(tls *libc.TLS, base uintptr, byteOffset uintptr_t) (r uint16_t) {
	var result uint16_t
	_ = result
	result = *(*uint16_t)(unsafe.Pointer(uintptr(uint64(base) + byteOffset)))
	return _OSSwapInt16(tls, result)
}

func OSReadSwapInt32(tls *libc.TLS, base uintptr, byteOffset uintptr_t) (r uint32_t) {
	var result uint32_t
	_ = result
	result = *(*uint32_t)(unsafe.Pointer(uintptr(uint64(base) + byteOffset)))
	return _OSSwapInt32(tls, result)
}

func OSReadSwapInt64(tls *libc.TLS, base uintptr, byteOffset uintptr_t) (r uint64_t) {
	var result uint64_t
	_ = result
	result = *(*uint64_t)(unsafe.Pointer(uintptr(uint64(base) + byteOffset)))
	return _OSSwapInt64(tls, result)
}

func OSWriteSwapInt16(tls *libc.TLS, base uintptr, byteOffset uintptr_t, data uint16_t) {
	*(*uint16_t)(unsafe.Pointer(uintptr(uint64(base) + byteOffset))) = _OSSwapInt16(tls, data)
}

func OSWriteSwapInt32(tls *libc.TLS, base uintptr, byteOffset uintptr_t, data uint32_t) {
	*(*uint32_t)(unsafe.Pointer(uintptr(uint64(base) + byteOffset))) = _OSSwapInt32(tls, data)
}

func OSWriteSwapInt64(tls *libc.TLS, base uintptr, byteOffset uintptr_t, data uint64_t) {
	*(*uint64_t)(unsafe.Pointer(uintptr(uint64(base) + byteOffset))) = _OSSwapInt64(tls, data)
}

const OSUnknownByteOrder = 0
const OSLittleEndian = 1
const OSBigEndian = 2

func OSHostByteOrder(tls *libc.TLS) (r int32_t) {
	return int32(OSLittleEndian)
}

func _OSReadInt16(tls *libc.TLS, base uintptr, byteOffset uintptr_t) (r uint16_t) {
	return *(*uint16_t)(unsafe.Pointer(uintptr(uint64(base) + byteOffset)))
}

func _OSReadInt32(tls *libc.TLS, base uintptr, byteOffset uintptr_t) (r uint32_t) {
	return *(*uint32_t)(unsafe.Pointer(uintptr(uint64(base) + byteOffset)))
}

func _OSReadInt64(tls *libc.TLS, base uintptr, byteOffset uintptr_t) (r uint64_t) {
	return *(*uint64_t)(unsafe.Pointer(uintptr(uint64(base) + byteOffset)))
}

func _OSWriteInt16(tls *libc.TLS, base uintptr, byteOffset uintptr_t, data uint16_t) {
	*(*uint16_t)(unsafe.Pointer(uintptr(uint64(base) + byteOffset))) = data
}

func _OSWriteInt32(tls *libc.TLS, base uintptr, byteOffset uintptr_t, data uint32_t) {
	*(*uint32_t)(unsafe.Pointer(uintptr(uint64(base) + byteOffset))) = data
}

func _OSWriteInt64(tls *libc.TLS, base uintptr, byteOffset uintptr_t, data uint64_t) {
	*(*uint64_t)(unsafe.Pointer(uintptr(uint64(base) + byteOffset))) = data
}
			...
			if *(*int32_t)(unsafe.Pointer(code_point)) >= int32(0xe0) {
				if *(*int32_t)(unsafe.Pointer(code_point)) < int32(0xf0) {
					...
					*(*int32_t)(unsafe.Pointer(v4)) &= int32(0xf)
					...
					__t = v5
					if v6 = int32(*(*int8)(unsafe.Pointer(__ccgo_ts + 665 + uintptr(*(*int32_t)(unsafe.Pointer(v4))))))&(int32(1)<<(libc.Int32FromUint8(v5)>>int32(5))) != 0; v6 {
					...
					*(*int32_t)(unsafe.Pointer(v7)) -= int32(0xf0)
					...
					if v11 = v9 && int32(*(*int8)(unsafe.Pointer(__ccgo_ts + 682 + uintptr(libc.Int32FromUint8(v8)>>int32(4)))))&(int32(1)<<*(*int32_t)(unsafe.Pointer(code_point))) != 0; v11 {
...
func ts_decode_utf16_le(tls *libc.TLS, string1 uintptr, length uint32_t, code_point uintptr) (r uint32_t) {
	...
	v1 = i
	i = i + 1
	*(*int32_t)(unsafe.Pointer(code_point)) = libc.Int32FromUint16(*(*uint16_t)(unsafe.Pointer(string1 + uintptr(v1)*2)))
...
func ts_decode_utf16_be(tls *libc.TLS, string1 uintptr, length uint32_t, code_point uintptr) (r uint32_t) {
	var __c2, v5 uint16_t
	var i, v2, v3, v4 uint32_t
	var v1 int32
	var v6 bool
	_, _, _, _, _, _, _, _ = __c2, i, v1, v2, v3, v4, v5, v6
	if length < uint32(2) {
		*(*int32_t)(unsafe.Pointer(code_point)) = TS_DECODE_ERROR
		return length
	}
	...
	if 0 != 0 {
		...
		v3 = i
		i = i + 1
		v1 = libc.Int32FromUint16(uint16(uint32(*(*uint16_t)(unsafe.Pointer(string1 + uintptr(v2)*2)))&libc.Uint32FromUint32(0xff00)>>libc.Int32FromInt32(8) | uint32(*(*uint16_t)(unsafe.Pointer(string1 + uintptr(v3)*2)))&libc.Uint32FromUint32(0x00ff)<<libc.Int32FromInt32(8)))
	} else {
		v4 = i
		i = i + 1
		v1 = libc.Int32FromUint16(_OSSwapInt16(tls, *(*uint16_t)(unsafe.Pointer(string1 + uintptr(v4)*2))))
	}
	*(*int32_t)(unsafe.Pointer(code_point)) = libc.Int32FromUint16(libc.Uint16FromInt32(v1))
	if libc.Uint32FromInt32(*(*int32_t)(unsafe.Pointer(code_point)))&uint32(0xfffffc00) == uint32(0xd800) {
		if v6 = i != length/uint32(2); v6 {
			v5 = *(*uint16_t)(unsafe.Pointer(string1 + uintptr(i)*2))
			__c2 = v5
		}
		if v6 && uint32(v5)&uint32(0xfffffc00) == uint32(0xdc00) {
			i = i + 1
			*(*int32_t)(unsafe.Pointer(code_point)) = *(*int32_t)(unsafe.Pointer(code_point))<<libc.Uint64FromUint64(10) + libc.Int32FromUint16(__c2) - (libc.Int32FromInt32(0xd800)<<libc.Uint64FromUint64(10) + libc.Int32FromInt32(0xdc00) - libc.Int32FromInt32(0x10000))
		}
	}
...
func ts_lexer__advance(tls *libc.TLS, _self uintptr, skip uint8) {
	...
	if skip != 0 {
		if (*Lexer)(unsafe.Pointer(self)).Flogger.Flog != 0 {
			...
			libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), v1, libc.VaList(bp+8, (*Lexer)(unsafe.Pointer(self)).Fdata.Flookahead))
...
func ts_lexer__log(tls *libc.TLS, _self uintptr, fmt uintptr, va uintptr) {
	...
	args = va
	if (*Lexer)(unsafe.Pointer(self)).Flogger.Flog != 0 {
		libc.X__builtin___vsnprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), fmt, args)
		(*(*func(*libc.TLS, uintptr, TSLogType1, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*Lexer)(unsafe.Pointer(self)).Flogger.Flog})))(tls, (*Lexer)(unsafe.Pointer(self)).Flogger.Fpayload, int32(TSLogTypeLex), self+192)
	}
	_ = args
}
...
func ts_lexer_set_included_ranges(tls *libc.TLS, self uintptr, ranges uintptr, count uint32_t) (r uint8) {
	...
	libc.X__builtin___memcpy_chk(tls, (*Lexer)(unsafe.Pointer(self)).Fincluded_ranges, ranges, size, ^__predefined_size_t(0))
...
func reusable_node_advance(tls *libc.TLS, self uintptr) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__14)), __ccgo_ts+781, int32(40), __ccgo_ts+137)
	}
	...
	for cond := true; cond; cond = ts_subtree_child_count(tls, *(*Subtree)(unsafe.Pointer(bp))) <= next_index {
		...
		*(*uint32_t)(unsafe.Pointer(v2)) = *(*uint32_t)(unsafe.Pointer(v2)) - 1
		...
		if libc.BoolInt64(!((*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__14)), __ccgo_ts+781, int32(52), __ccgo_ts+137)
		}
...
func reusable_node_descend(tls *libc.TLS, self uintptr) (r uint8) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__15)), __ccgo_ts+781, int32(63), __ccgo_ts+137)
	}
...
func ts_parser__log(tls *libc.TLS, self uintptr) {
	...
	if (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
		libc.Xfprintf(tls, (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file, __ccgo_ts+798, 0)
		chr = self + 192
		for {
		...
		libc.Xfprintf(tls, (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file, __ccgo_ts+814, 0)
	}
}
	...
	for cond := true; cond; cond = pending != 0 {
		*(*StackSliceArray)(unsafe.Pointer(bp)) = ts_stack_pop_pending(tls, (*TSParser)(unsafe.Pointer(self)).Fstack, version)
		...
		for {
			...
			if libc.BoolInt64(!(i < (*StackSliceArray)(unsafe.Pointer(bp)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__16)), __ccgo_ts+820, int32(190), __ccgo_ts+829)
			}
			...
			*(*Subtree)(unsafe.Pointer(bp + 40)) = Subtree{}
			if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*SubtreeArray)(unsafe.Pointer(bp+16)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__16)), __ccgo_ts+820, int32(192), __ccgo_ts+858)
			}
			*(*struct {
				Fptr  [0]uintptr
				Fdata SubtreeInlineData
			...
			for {
				...
				if libc.BoolInt64(!(j1 < (*SubtreeArray)(unsafe.Pointer(bp+16)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__16)), __ccgo_ts+820, int32(209), __ccgo_ts+898)
				}
			...
			if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+938, libc.VaList(bp+56, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 40))))))
			...
			if (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				...
				libc.Xfputs(tls, __ccgo_ts+969, (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file)
			}
			goto _1
		_1:
			;
...
func ts_parser__breakdown_lookahead(tls *libc.TLS, self uintptr, lookahead uintptr, state TSStateId, reusable_node uintptr) {
	...
	for ts_subtree_child_count(tls, tree) > uint32(0) && libc.Int32FromUint16(ts_subtree_parse_state(tls, tree)) != libc.Int32FromUint16(state) {
		if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
			libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+972, libc.VaList(bp+8, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, tree))))
			ts_parser__log(tls, self)
		}
...
func ts_parser__external_scanner_serialize(tls *libc.TLS, self uintptr) (r uint32) {
	...
	if libc.BoolInt64(!(length <= libc.Uint32FromInt32(1024))) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__17)), __ccgo_ts+820, int32(409), __ccgo_ts+994)
	}
	return length
}
...
func ts_parser__lex(tls *libc.TLS, self uintptr, version StackVersion, parse_state TSStateId) (r Subtree) {
	...
	if libc.Int32FromUint16(lex_mode.Flex_state) == libc.Int32FromUint16(libc.Uint16FromInt32(-libc.Int32FromInt32(1))) {
		if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
			libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1009, 0)
			ts_parser__log(tls, self)
		}
		return Subtree{}
	}
	...
	*(*uint32_t)(unsafe.Pointer(bp)) = uint32(0)
	...
	for {
		...
		if libc.Int32FromUint16(lex_mode.Fexternal_lex_state) != 0 {
			if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1047, libc.VaList(bp+24, libc.Int32FromUint16(lex_mode.Fexternal_lex_state), current_position.Fextent.Frow, current_position.Fextent.Fcolumn))
				ts_parser__log(tls, self)
			}
		...
		if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
			libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1126, libc.VaList(bp+24, libc.Int32FromUint16(lex_mode.Flex_state), current_position.Fextent.Frow, current_position.Fextent.Fcolumn))
			ts_parser__log(tls, self)
		}
		ts_lexer_start(tls, self)
		...
		if !(skipped_error != 0) {
			if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1167, 0)
				ts_parser__log(tls, self)
			}
	...
	if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
		...
		off = libc.X__builtin___snprintf_chk(tls, buf, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1195, 0)
		i = 0
		for {
		...
		libc.X__builtin___snprintf_chk(tls, buf+uintptr(off), libc.Uint64FromInt32(int32(1024)-off), 0, ^__predefined_size_t(0), __ccgo_ts+1216, libc.VaList(bp+24, ts_subtree_total_size(tls, result).Fbytes))
		ts_parser__log(tls, self)
	}
	return result
}
...
func ts_parser__reuse_node(tls *libc.TLS, self uintptr, version StackVersion, state uintptr, position uint32_t, last_external_token Subtree, table_entry uintptr) (r Subtree) {
	...
	for *(*uintptr)(unsafe.Pointer(bp)) != 0 {
		...
		if byte_offset > position {
			if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1226, libc.VaList(bp+16, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp))))))
				ts_parser__log(tls, self)
			}
			break
		}
		if byte_offset < position {
			if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1257, libc.VaList(bp+16, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp))))))
				ts_parser__log(tls, self)
			}
		...
		if !(ts_subtree_external_scanner_state_eq(tls, (*TSParser)(unsafe.Pointer(self)).Freusable_node.Flast_external_token, last_external_token) != 0) {
			if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1286, libc.VaList(bp+16, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp))))))
				ts_parser__log(tls, self)
			}
			reusable_node_advance(tls, self+1368)
			continue
		...
		if ts_subtree_has_changes(tls, *(*Subtree)(unsafe.Pointer(bp))) != 0 {
			reason = __ccgo_ts + 1347
		} else {
			if ts_subtree_is_error(tls, *(*Subtree)(unsafe.Pointer(bp))) != 0 {
				reason = __ccgo_ts + 1359
			} else {
				if ts_subtree_missing(tls, *(*Subtree)(unsafe.Pointer(bp))) != 0 {
					reason = __ccgo_ts + 1368
				} else {
					if ts_subtree_is_fragile(tls, *(*Subtree)(unsafe.Pointer(bp))) != 0 {
						reason = __ccgo_ts + 1379
					} else {
						if ts_subtree_is_eof(tls, *(*Subtree)(unsafe.Pointer(bp))) != 0 {
							v1 = end_byte_offset
						} else {
							v1 = end_byte_offset + ts_subtree_lookahead_bytes(tls, *(*Subtree)(unsafe.Pointer(bp)))
						}
						if ts_parser__has_included_range_difference(tls, self, byte_offset, v1) != 0 {
							reason = __ccgo_ts + 1390
						}
					}
				}
			}
		...
		if reason != 0 {
			if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1424, libc.VaList(bp+16, reason, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp))))))
				ts_parser__log(tls, self)
			}
		...
		if !(ts_parser__can_reuse_first_leaf(tls, self, *(*TSStateId)(unsafe.Pointer(state)), *(*Subtree)(unsafe.Pointer(bp)), table_entry) != 0) {
			if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1451, libc.VaList(bp+16, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp)))), ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, leaf_symbol)))
				ts_parser__log(tls, self)
			}
		...
		if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
			libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1499, libc.VaList(bp+16, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp))))))
			ts_parser__log(tls, self)
		}
		ts_subtree_retain(tls, *(*Subtree)(unsafe.Pointer(bp)))
...
func ts_parser__select_tree(tls *libc.TLS, self uintptr, _left Subtree, _right Subtree) (r uint8) {
	...
	*(*Subtree)(unsafe.Pointer(bp + 8)) = _right
	...
	case -int32(1):
		if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
			libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1642, libc.VaList(bp+24, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp)))), ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 8))))))
			ts_parser__log(tls, self)
		}
		return libc.BoolUint8(0 != 0)
	case int32(1):
	...
	default:
		if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
			libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1683, libc.VaList(bp+24, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp)))), ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 8))))))
			ts_parser__log(tls, self)
		}
		return libc.BoolUint8(0 != 0)
	}
...
func ts_parser__reduce(tls *libc.TLS, self uintptr, version StackVersion, symbol TSSymbol, count uint32_t, dynamic_precedence int32, production_id uint16_t, is_fragile uint8, end_of_non_terminal_extra uint8) (r StackVersion) {
	...
	*(*StackSliceArray)(unsafe.Pointer(bp)) = ts_stack_pop_count(tls, (*TSParser)(unsafe.Pointer(self)).Fstack, version, count)
	...
	for {
		...
		if libc.BoolInt64(!(i < (*StackSliceArray)(unsafe.Pointer(bp)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__18)), __ccgo_ts+820, int32(958), __ccgo_ts+829)
		}
		*(*StackSlice)(unsafe.Pointer(bp + 16)) = *(*StackSlice)(unsafe.Pointer((*StackSliceArray)(unsafe.Pointer(bp)).Fcontents + uintptr(i)*24))
		...
		if slice_version > MAX_VERSION_COUNT+MAX_VERSION_COUNT_OVERFLOW+halted_version_count {
			...
			for i+uint32(1) < (*(*StackSliceArray)(unsafe.Pointer(bp))).Fsize {
				if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
					libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+1725, 0)
					ts_parser__log(tls, self)
				}
				if libc.BoolInt64(!(i+libc.Uint32FromInt32(1) < (*StackSliceArray)(unsafe.Pointer(bp)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__18)), __ccgo_ts+820, int32(971), __ccgo_ts+1764)
				}
		...
		*(*struct {
		...
		for i+uint32(1) < (*(*StackSliceArray)(unsafe.Pointer(bp))).Fsize {
			if libc.BoolInt64(!(i+libc.Uint32FromInt32(1) < (*StackSliceArray)(unsafe.Pointer(bp)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__18)), __ccgo_ts+820, int32(994), __ccgo_ts+1764)
			}
		...
		if is_fragile != 0 || (*(*StackSliceArray)(unsafe.Pointer(bp))).Fsize > uint32(1) || initial_version_count > uint32(1) {
			...
			(*SubtreeHeapData)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 80)))).Fparse_state = libc.Uint16FromInt32(libc.Int32FromInt32(32767)*libc.Int32FromInt32(2) + libc.Int32FromInt32(1))
		} else {
		...
		*(*int32_t)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 80)) + 60)) += dynamic_precedence
		...
		for {
			...
			if libc.BoolInt64(!(j < (*SubtreeArray)(unsafe.Pointer(self+1296)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__18)), __ccgo_ts+820, int32(1036), __ccgo_ts+1797)
			}
...
func ts_parser__accept(tls *libc.TLS, self uintptr, version StackVersion, lookahead Subtree) {
	...
	if libc.BoolInt64(!(ts_subtree_is_eof(tls, lookahead) != 0)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__19)), __ccgo_ts+820, int32(1059), __ccgo_ts+1844)
	}
	...
	*(*StackSliceArray)(unsafe.Pointer(bp)) = ts_stack_pop_all(tls, (*TSParser)(unsafe.Pointer(self)).Fstack, version)
	...
	for {
		...
		if libc.BoolInt64(!(i < (*StackSliceArray)(unsafe.Pointer(bp)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__19)), __ccgo_ts+820, int32(1064), __ccgo_ts+829)
		}
		...
		*(*struct {
		...
		for {
			...
			*(*Subtree)(unsafe.Pointer(bp + 40)) = Subtree{}
			if libc.BoolInt64(!(j < (*SubtreeArray)(unsafe.Pointer(bp+16)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__19)), __ccgo_ts+820, int32(1068), __ccgo_ts+1873)
			}
			*(*struct {
				Fptr  [0]uintptr
				Fdata SubtreeInlineData
			...
			if !(ts_subtree_extra(tls, *(*Subtree)(unsafe.Pointer(bp + 40))) != 0) {
				if libc.BoolInt64(!!(int32(*(*uint8)(unsafe.Pointer(bp + 40 + 0))&0x1>>0) != 0)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__19)), __ccgo_ts+820, int32(1070), __ccgo_ts+1904)
				}
		...
		if libc.BoolInt64(!(*(*uintptr)(unsafe.Pointer(bp + 32)) != 0)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__19)), __ccgo_ts+820, int32(1088), __ccgo_ts+1925)
		}
	...
	if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*StackSliceArray)(unsafe.Pointer(bp)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__19)), __ccgo_ts+820, int32(1103), __ccgo_ts+1934)
	}
...
func ts_parser__do_all_potential_reductions(tls *libc.TLS, self uintptr, starting_version StackVersion, lookahead_symbol TSSymbol) (r uint8) {
	...
	var state TSStateId
	var _ /* entry at bp+0 */ TableEntry
	var _ /* iter at bp+16 */ LookaheadIterator
	...
	for {
		...
		if libc.Int32FromUint16(lookahead_symbol) != 0 {
			...
			*(*LookaheadIterator)(unsafe.Pointer(bp + 16)) = ts_language_lookaheads(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, state)
			for ts_lookahead_iterator__next(tls, bp+16) != 0 {
				if libc.Int32FromUint16((*(*LookaheadIterator)(unsafe.Pointer(bp + 16))).Fsymbol) == 0 || uint32((*(*LookaheadIterator)(unsafe.Pointer(bp + 16))).Fsymbol) >= (*TSLanguage)(unsafe.Pointer((*TSParser)(unsafe.Pointer(self)).Flanguage)).Ftoken_count {
					continue
				}
				if ts_parser__process_candidate_recovery_actions(tls, self, (*(*LookaheadIterator)(unsafe.Pointer(bp + 16))).Factions, uint32((*(*LookaheadIterator)(unsafe.Pointer(bp + 16))).Faction_count)) != 0 {
					has_shift_action = libc.BoolUint8(1 != 0)
				}
			}
			j1 = uint32(1)
		...
		for {
			...
			if libc.BoolInt64(!(j2 < (*ReduceActionSet)(unsafe.Pointer(self+1272)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__20)), __ccgo_ts+820, int32(1194), __ccgo_ts+1963)
			}
			action = *(*ReduceAction)(unsafe.Pointer((*ReduceActionSet)(unsafe.Pointer(self+1272)).Fcontents + uintptr(j2)*16))
...
func ts_parser__recover_to_state(tls *libc.TLS, self uintptr, version StackVersion, depth uint32, goal_state TSStateId) (r uint8) {
	...
	*(*StackSliceArray)(unsafe.Pointer(bp)) = ts_stack_pop_count(tls, (*TSParser)(unsafe.Pointer(self)).Fstack, version, depth)
	...
	for {
		...
		if libc.BoolInt64(!(i < (*StackSliceArray)(unsafe.Pointer(bp)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__21)), __ccgo_ts+820, int32(1232), __ccgo_ts+829)
		}
		*(*StackSlice)(unsafe.Pointer(bp + 16)) = *(*StackSlice)(unsafe.Pointer((*StackSliceArray)(unsafe.Pointer(bp)).Fcontents + uintptr(i)*24))
		...
		*(*SubtreeArray)(unsafe.Pointer(bp + 40)) = ts_stack_pop_error(tls, (*TSParser)(unsafe.Pointer(self)).Fstack, (*(*StackSlice)(unsafe.Pointer(bp + 16))).Fversion)
		if (*(*SubtreeArray)(unsafe.Pointer(bp + 40))).Fsize > uint32(0) {
			if libc.BoolInt64(!((*(*SubtreeArray)(unsafe.Pointer(bp + 40))).Fsize == libc.Uint32FromInt32(1))) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__21)), __ccgo_ts+820, int32(1249), __ccgo_ts+2009)
			}
			*(*Subtree)(unsafe.Pointer(bp + 56)) = Subtree{}
			if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*SubtreeArray)(unsafe.Pointer(bp+40)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__21)), __ccgo_ts+820, int32(1250), __ccgo_ts+2031)
			}
			*(*struct {
				Fptr  [0]uintptr
				Fdata SubtreeInlineData
			...
			if error_child_count > uint32(0) {
				...
				for {
					...
					if libc.BoolInt64(!(j < (*SubtreeArray)(unsafe.Pointer(bp+16)).Fsize)) != 0 {
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__21)), __ccgo_ts+820, int32(1255), __ccgo_ts+898)
					}
		...
		for {
			...
			if libc.BoolInt64(!(j1 < (*SubtreeArray)(unsafe.Pointer(self+1296)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__21)), __ccgo_ts+820, int32(1271), __ccgo_ts+1797)
			}
...
func ts_parser__recover(tls *libc.TLS, self uintptr, version StackVersion, lookahead Subtree) {
	...
	if summary != 0 && !(ts_subtree_is_error(tls, lookahead) != 0) {
		...
		for {
			...
			if libc.BoolInt64(!(i < (*StackSummary)(unsafe.Pointer(summary)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__22)), __ccgo_ts+820, int32(1307), __ccgo_ts+2068)
			}
			...
			if ts_language_has_actions(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, entry.Fstate, ts_subtree_symbol(tls, lookahead)) != 0 {
				if ts_parser__recover_to_state(tls, self, version, depth, entry.Fstate) != 0 {
					...
					if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
						libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2100, libc.VaList(bp+72, libc.Int32FromUint16(entry.Fstate), depth))
						ts_parser__log(tls, self)
					}
					if (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
						ts_stack_print_dot_graph(tls, (*TSParser)(unsafe.Pointer(self)).Fstack, (*TSParser)(unsafe.Pointer(self)).Flanguage, (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file)
	...
	for {
		...
		if !(ts_stack_is_active(tls, (*TSParser)(unsafe.Pointer(self)).Fstack, i1) != 0) {
			if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2139, libc.VaList(bp+72, i1))
				ts_parser__log(tls, self)
			}
			v4 = i1
			i1 = i1 - 1
	...
	if ts_subtree_is_eof(tls, lookahead) != 0 {
		if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
			libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2165, 0)
			ts_parser__log(tls, self)
		}
	...
	if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
		libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2177, libc.VaList(bp+72, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, lookahead))))
		ts_parser__log(tls, self)
	}
	...
	*(*Subtree)(unsafe.Pointer((*SubtreeArray)(unsafe.Pointer(bp+32)).Fcontents + uintptr(v5)*8)) = lookahead
	...
	if node_count_since_error > uint32(0) {
		*(*StackSliceArray)(unsafe.Pointer(bp + 48)) = ts_stack_pop_count(tls, (*TSParser)(unsafe.Pointer(self)).Fstack, version, uint32(1))
		if (*(*StackSliceArray)(unsafe.Pointer(bp + 48))).Fsize > uint32(1) {
			...
			for {
				...
				if libc.BoolInt64(!(i2 < (*StackSliceArray)(unsafe.Pointer(bp+48)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__22)), __ccgo_ts+820, int32(1434), __ccgo_ts+829)
				}
			...
			for {
				if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*StackSliceArray)(unsafe.Pointer(bp+48)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__22)), __ccgo_ts+820, int32(1436), __ccgo_ts+1934)
				}
				...
				if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*StackSliceArray)(unsafe.Pointer(bp+48)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__22)), __ccgo_ts+820, int32(1437), __ccgo_ts+1934)
				}
		...
		if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*StackSliceArray)(unsafe.Pointer(bp+48)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__22)), __ccgo_ts+820, int32(1441), __ccgo_ts+1934)
		}
		...
		if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*StackSliceArray)(unsafe.Pointer(bp+48)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__22)), __ccgo_ts+820, int32(1442), __ccgo_ts+1934)
		}
		if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*StackSliceArray)(unsafe.Pointer(bp+48)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__22)), __ccgo_ts+820, int32(1442), __ccgo_ts+1934)
		}
		...
		*(*Subtree)(unsafe.Pointer((*SubtreeArray)(unsafe.Pointer((*StackSliceArray)(unsafe.Pointer(bp+48)).Fcontents)).Fcontents + uintptr(v5)*8)) = ts_subtree_from_mut(tls, error_repeat)
		if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*StackSliceArray)(unsafe.Pointer(bp+48)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__22)), __ccgo_ts+820, int32(1445), __ccgo_ts+1934)
		}
	...
	*(*Subtree)(unsafe.Pointer(bp)) = _lookahead
			...
			for {
				...
				if ts_language_has_reduce_action(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, state_after_missing_symbol, ts_subtree_leaf_symbol(tls, *(*Subtree)(unsafe.Pointer(bp)))) != 0 {
					...
					if ts_parser__do_all_potential_reductions(tls, self, version_with_missing_tree, ts_subtree_leaf_symbol(tls, *(*Subtree)(unsafe.Pointer(bp)))) != 0 {
						if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
							libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2198, libc.VaList(bp+16, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, missing_symbol), libc.Int32FromUint16(ts_stack_state(tls, (*TSParser)(unsafe.Pointer(self)).Fstack, version_with_missing_tree))))
							ts_parser__log(tls, self)
						}
	...
	for {
		...
		if libc.BoolInt64(!(did_merge != 0)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__23)), __ccgo_ts+820, int32(1549), __ccgo_ts+2239)
		}
		goto _4
	_4:
		;
	...
	for {
			...
			*(*struct {
			...
			case int32(TSParseActionTypeShift):
				...
				if (*(*TSParseAction)(unsafe.Pointer(bp + 32))).Fshift.Fextra != 0 {
					...
					if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
						libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2249, 0)
						ts_parser__log(tls, self)
					}
				} else {
					next_state = (*(*TSParseAction)(unsafe.Pointer(bp + 32))).Fshift.Fstate
					if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
						libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2261, libc.VaList(bp+56, libc.Int32FromUint16(next_state)))
						ts_parser__log(tls, self)
					}
				}
			...
			case int32(TSParseActionTypeReduce):
				...
				if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
					libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2276, libc.VaList(bp+56, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, (*(*struct {
						Ftype1              uint8_t
						Fchild_count        uint8_t
						Fsymbol             TSSymbol
						Fdynamic_precedence int16_t
			...
			case int32(TSParseActionTypeAccept):
				if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
					libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2306, 0)
					ts_parser__log(tls, self)
				}
		...
		if ts_subtree_is_keyword(tls, *(*Subtree)(unsafe.Pointer(bp + 8))) != 0 && libc.Int32FromUint16(ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 8)))) != libc.Int32FromUint16((*TSLanguage)(unsafe.Pointer((*TSParser)(unsafe.Pointer(self)).Flanguage)).Fkeyword_capture_token) && !(ts_language_is_reserved_word(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, *(*TSStateId)(unsafe.Pointer(bp)), ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 8)))) != 0) {
			...
			if (*(*TableEntry)(unsafe.Pointer(bp + 16))).Faction_count > uint32(0) {
				if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
					libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2313, libc.VaList(bp+56, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 8)))), ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, (*TSLanguage)(unsafe.Pointer((*TSParser)(unsafe.Pointer(self)).Flanguage)).Fkeyword_capture_token)))
					ts_parser__log(tls, self)
				}
		...
		if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
			libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2354, libc.VaList(bp+56, ts_language_symbol_name(tls, (*TSParser)(unsafe.Pointer(self)).Flanguage, ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 8))))))
			ts_parser__log(tls, self)
		}
...
func ts_parser__condense_stack(tls *libc.TLS, self uintptr) (r uint32) {
		...
		for {
			...
			if ts_stack_is_paused(tls, (*TSParser)(unsafe.Pointer(self)).Fstack, i1) != 0 {
				if !(has_unpaused_version != 0) && (*TSParser)(unsafe.Pointer(self)).Faccept_count < MAX_VERSION_COUNT {
					if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
						libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2380, libc.VaList(bp+8, i1))
						ts_parser__log(tls, self)
					}
	...
	if made_changes != 0 {
		if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
			libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2398, 0)
			ts_parser__log(tls, self)
		}
		if (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
			ts_stack_print_dot_graph(tls, (*TSParser)(unsafe.Pointer(self)).Fstack, (*TSParser)(unsafe.Pointer(self)).Flanguage, (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file)
...
func ts_parser__balance_subtree(tls *libc.TLS, self uintptr) (r uint8) {
	...
	*(*struct {
	...
	for (*TSParser)(unsafe.Pointer(self)).Ftree_pool.Ftree_stack.Fsize > uint32(0) {
		...
		*(*MutableSubtree)(unsafe.Pointer(bp + 8)) = MutableSubtree{}
		if libc.BoolInt64(!((*TSParser)(unsafe.Pointer(self)).Ftree_pool.Ftree_stack.Fsize-libc.Uint32FromInt32(1) < (*MutableSubtreeArray)(unsafe.Pointer(self+1224+16)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__24)), __ccgo_ts+820, int32(1918), __ccgo_ts+2407)
		}
		*(*struct {
			Fptr  [0]uintptr
			Fdata SubtreeInlineData
...
func ts_parser_print_dot_graphs(tls *libc.TLS, self uintptr, fd int32) {
	...
	if fd >= 0 {
		(*TSParser)(unsafe.Pointer(self)).Fdot_graph_file = libc.Xfdopen(tls, fd, __ccgo_ts+2493)
	} else {
		(*TSParser)(unsafe.Pointer(self)).Fdot_graph_file = libc.UintptrFromInt32(0)
	}
}
...
func ts_parser_parse(tls *libc.TLS, self uintptr, old_tree uintptr, input TSInput) (r uintptr) {
	...
	if ts_parser_has_outstanding_parse(tls, self) != 0 {
		if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
			libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2495, 0)
			ts_parser__log(tls, self)
		}
		if (*TSParser)(unsafe.Pointer(self)).Fcanceled_balancing != 0 {
			goto balance
		...
		if old_tree != 0 {
			...
			if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2510, 0)
				ts_parser__log(tls, self)
			}
			if (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				...
				libc.Xfputs(tls, __ccgo_ts+2527, (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file)
			}
			i = uint32(0)
			for {
				...
				if libc.BoolInt64(!(i < (*TSRangeArray)(unsafe.Pointer(self+1424)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__25)), __ccgo_ts+820, int32(2143), __ccgo_ts+2529)
				}
				range1 = (*TSRangeArray)(unsafe.Pointer(self+1424)).Fcontents + uintptr(i)*24
				if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
					libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2587, libc.VaList(bp+8, (*TSRange)(unsafe.Pointer(range1)).Fstart_byte, (*TSRange)(unsafe.Pointer(range1)).Fend_byte))
					ts_parser__log(tls, self)
				}
				goto _1
			_1:
			...
			reusable_node_clear(tls, self+1368)
			if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
				libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2620, 0)
				ts_parser__log(tls, self)
			}
		}
	}
	...
	for cond := true; cond; cond = version_count != uint32(0) {
		...
		for (*TSParser)(unsafe.Pointer(self)).Fincluded_range_difference_index < (*TSParser)(unsafe.Pointer(self)).Fincluded_range_differences.Fsize {
			if libc.BoolInt64(!((*TSParser)(unsafe.Pointer(self)).Fincluded_range_difference_index < (*TSRangeArray)(unsafe.Pointer(self+1424)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__25)), __ccgo_ts+820, int32(2200), __ccgo_ts+2693)
			}
...
balance:
	;
	if libc.BoolInt64(!(*(*uintptr)(unsafe.Pointer(self + 1288)) != 0)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__25)), __ccgo_ts+820, int32(2210), __ccgo_ts+2787)
	}
	...
	(*TSParser)(unsafe.Pointer(self)).Fcanceled_balancing = libc.BoolUint8(0 != 0)
	if (*TSParser)(unsafe.Pointer(self)).Flexer.Flogger.Flog != 0 || (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
		libc.X__builtin___snprintf_chk(tls, self+192, uint64(1024), 0, ^__predefined_size_t(0), __ccgo_ts+2811, 0)
		ts_parser__log(tls, self)
	}
	if (*TSParser)(unsafe.Pointer(self)).Fdot_graph_file != 0 {
...
var PATTERN_DONE_MARKER = uint16(65535)
var NONE = uint16(65535)
var CAPTURE_LIST_NONE = uint32(4294967295)
...
func stream_skip_whitespace(tls *libc.TLS, self uintptr) {
	for {
		if iswspace(tls, (*Stream)(unsafe.Pointer(self)).Fnext) != 0 {
			stream_advance(tls, self)
		} else {
...
func stream_is_ident_start(tls *libc.TLS, self uintptr) (r uint8) {
	return libc.BoolUint8(iswalnum(tls, (*Stream)(unsafe.Pointer(self)).Fnext) != 0 || (*Stream)(unsafe.Pointer(self)).Fnext == int32('_') || (*Stream)(unsafe.Pointer(self)).Fnext == int32('-'))
}

func stream_scan_identifier(tls *libc.TLS, stream uintptr) {
	for cond := true; cond; cond = iswalnum(tls, (*Stream)(unsafe.Pointer(stream)).Fnext) != 0 || (*Stream)(unsafe.Pointer(stream)).Fnext == int32('_') || (*Stream)(unsafe.Pointer(stream)).Fnext == int32('-') || (*Stream)(unsafe.Pointer(stream)).Fnext == int32('.') {
...
func capture_list_pool_new(tls *libc.TLS) (r CaptureListPool) {
	return CaptureListPool{
		Fmax_capture_list_count: uint32(4294967295),
	}
}
...
func capture_list_pool_reset(tls *libc.TLS, self uintptr) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__26)), __ccgo_ts+2816, int32(455), __ccgo_ts+2824)
		}
...
func capture_list_pool_delete(tls *libc.TLS, self uintptr) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__27)), __ccgo_ts+2816, int32(462), __ccgo_ts+2824)
		}
...
func capture_list_pool_get(tls *libc.TLS, self uintptr, id uint32_t) (r uintptr) {
	...
	if libc.BoolInt64(!(id < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__28)), __ccgo_ts+2816, int32(469), __ccgo_ts+2860)
	}
	return (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func capture_list_pool_get_mut(tls *libc.TLS, self uintptr, id uint32_t) (r uintptr) {
	if libc.BoolInt64(!(id < (*CaptureListPool)(unsafe.Pointer(self)).Flist.Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__29)), __ccgo_ts+2816, int32(473), __ccgo_ts+2897)
	}
	if libc.BoolInt64(!(id < (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__29)), __ccgo_ts+2816, int32(474), __ccgo_ts+2860)
	}
	return (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	if (*CaptureListPool)(unsafe.Pointer(self)).Ffree_capture_list_count > uint32(0) {
		...
		for {
			...
			if libc.BoolInt64(!(i < (*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__30)), __ccgo_ts+2816, int32(487), __ccgo_ts+2824)
			}
			if (*CaptureList)(unsafe.Pointer((*struct {
				Fcontents uintptr
				Fsize     uint32_t
				...
				if libc.BoolInt64(!(i < (*struct {
					...
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__30)), __ccgo_ts+2816, int32(488), __ccgo_ts+2824)
				}
				(*CaptureList)(unsafe.Pointer((*struct {
					Fcontents uintptr
					Fsize     uint32_t
...
func capture_list_pool_release(tls *libc.TLS, self uintptr, id uint32_t) {
	...
	if libc.BoolInt64(!(id < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__31)), __ccgo_ts+2816, int32(509), __ccgo_ts+2860)
	}
	(*CaptureList)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self)).Fcontents + uintptr(id)*16)).Fsize = uint32(4294967295)
	(*CaptureListPool)(unsafe.Pointer(self)).Ffree_capture_list_count = (*CaptureListPool)(unsafe.Pointer(self)).Ffree_capture_list_count + 1
}
...
func finished_state_swap(tls *libc.TLS, states uintptr, a uint32_t, b uint32_t) {
	...
	if libc.BoolInt64(!(a < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__32)), __ccgo_ts+2816, int32(525), __ccgo_ts+2918)
	}
	tmp = *(*QueryState)(unsafe.Pointer((*QueryStateList)(unsafe.Pointer(states)).Fcontents + uintptr(a)*24))
	if libc.BoolInt64(!(a < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__32)), __ccgo_ts+2816, int32(526), __ccgo_ts+2918)
	}
	if libc.BoolInt64(!(b < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__32)), __ccgo_ts+2816, int32(526), __ccgo_ts+2949)
	}
	*(*QueryState)(unsafe.Pointer((*QueryStateList)(unsafe.Pointer(states)).Fcontents + uintptr(a)*24)) = *(*QueryState)(unsafe.Pointer((*QueryStateList)(unsafe.Pointer(states)).Fcontents + uintptr(b)*24))
	if libc.BoolInt64(!(b < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__32)), __ccgo_ts+2816, int32(527), __ccgo_ts+2949)
	}
...
func finished_state_precedes(tls *libc.TLS, a uintptr, b uintptr, pool uintptr) (r uint8) {
	...
	a_byte = ts_node_start_byte(tls, (*(*TSQueryCapture)(unsafe.Pointer((*CaptureList)(unsafe.Pointer(a_caps)).Fcontents + uintptr(int32(*(*uint16)(unsafe.Pointer(a + 18))&0xfff>>0))*40))).Fnode)
	b_byte = ts_node_start_byte(tls, (*(*TSQueryCapture)(unsafe.Pointer((*CaptureList)(unsafe.Pointer(b_caps)).Fcontents + uintptr(int32(*(*uint16)(unsafe.Pointer(b + 18))&0xfff>>0))*40))).Fnode)
	if a_byte != b_byte {
	...
	for int32(1) != 0 {
		...
		if v1 = left < size; v1 {
			if libc.BoolInt64(!(left < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__33)), __ccgo_ts+2816, int32(559), __ccgo_ts+2980)
			}
			if libc.BoolInt64(!(smallest < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__33)), __ccgo_ts+2816, int32(560), __ccgo_ts+3014)
			}
		}
		...
		if v1 = right < size; v1 {
			if libc.BoolInt64(!(right < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__33)), __ccgo_ts+2816, int32(566), __ccgo_ts+3052)
			}
			if libc.BoolInt64(!(smallest < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__33)), __ccgo_ts+2816, int32(567), __ccgo_ts+3014)
			}
		}
...
func finished_state_sift_up(tls *libc.TLS, states uintptr, index uint32_t, pool uintptr) {
	...
	for index > uint32(0) {
		...
		if libc.BoolInt64(!(index < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__34)), __ccgo_ts+2816, int32(586), __ccgo_ts+3087)
		}
		if libc.BoolInt64(!(parent < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__34)), __ccgo_ts+2816, int32(587), __ccgo_ts+3122)
		}
...
func finished_state_pop(tls *libc.TLS, states uintptr, pool uintptr) {
	if (*QueryStateList)(unsafe.Pointer(states)).Fsize > uint32(1) {
		if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__35)), __ccgo_ts+2816, int32(599), __ccgo_ts+3158)
		}
		if libc.BoolInt64(!((*QueryStateList)(unsafe.Pointer(states)).Fsize-libc.Uint32FromInt32(1) < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__35)), __ccgo_ts+2816, int32(599), __ccgo_ts+3189)
		}
...
func finished_state_erase(tls *libc.TLS, states uintptr, index uint32_t, pool uintptr) {
	...
	if libc.BoolInt64(!(index < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__36)), __ccgo_ts+2816, int32(614), __ccgo_ts+3087)
	}
	if libc.BoolInt64(!((*QueryStateList)(unsafe.Pointer(states)).Fsize-libc.Uint32FromInt32(1) < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__36)), __ccgo_ts+2816, int32(614), __ccgo_ts+3189)
	}
	*(*QueryState)(unsafe.Pointer((*QueryStateList)(unsafe.Pointer(states)).Fcontents + uintptr(index)*24)) = *(*QueryState)(unsafe.Pointer((*QueryStateList)(unsafe.Pointer(states)).Fcontents + uintptr((*QueryStateList)(unsafe.Pointer(states)).Fsize-uint32(1))*24))
	...
	if v1 = index > uint32(0); v1 {
		if libc.BoolInt64(!(index < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__36)), __ccgo_ts+2816, int32(618), __ccgo_ts+3087)
		}
		if libc.BoolInt64(!((index-libc.Uint32FromInt32(1))/libc.Uint32FromInt32(2) < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__36)), __ccgo_ts+2816, int32(619), __ccgo_ts+3237)
		}
	}
...
func ts_query_cursor__push_finished_state(tls *libc.TLS, self uintptr, state uintptr) {
	...
	*(*uint32_t)(unsafe.Pointer(v2)) = *(*uint32_t)(unsafe.Pointer(v2)) + 1
	...
	(*QueryStateList)(unsafe.Pointer(self + 56)).Fcontents = _array__grow(tls, (*QueryStateList)(unsafe.Pointer(self+56)).Fcontents, (*QueryStateList)(unsafe.Pointer(self+56)).Fsize, self+56+12, uint32(1), libc.Uint64FromInt64(24))
	v2 = self + 56 + 8
	v1 = *(*uint32_t)(unsafe.Pointer(v2))
	*(*uint32_t)(unsafe.Pointer(v2)) = *(*uint32_t)(unsafe.Pointer(v2)) + 1
	*(*QueryState)(unsafe.Pointer((*QueryStateList)(unsafe.Pointer(self+56)).Fcontents + uintptr(v1)*24)) = *(*QueryState)(unsafe.Pointer(state))
}
...
func ts_query_cursor__heapify_finished_states(tls *libc.TLS, self uintptr) {
	for (*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states_heap_size < (*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states.Fsize {
		finished_state_sift_up(tls, self+56, (*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states_heap_size, self+80)
...
func capture_quantifier_for_id(tls *libc.TLS, self uintptr, id uint16_t) (r TSQuantifier1) {
	...
	if (*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize <= uint32(id) {
		...
		if libc.BoolInt64(!(uint32(id) < (*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__37)), __ccgo_ts+2816, int32(843), __ccgo_ts+3282)
		}
...
func capture_quantifiers_add_for_id(tls *libc.TLS, self uintptr, id uint16_t, quantifier TSQuantifier1) {
	...
	if (*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize <= uint32(id) {
		...
		libc.X__builtin___memset_chk(tls, (*CaptureQuantifiers)(unsafe.Pointer(self)).Fcontents+uintptr((*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize), 0, uint64(libc.Uint32FromInt32(libc.Int32FromUint16(id)+libc.Int32FromInt32(1))-(*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize)*libc.Uint64FromInt64(1), ^__predefined_size_t(0))
	...
	if libc.BoolInt64(!(uint32(id) < (*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__38)), __ccgo_ts+2816, int32(855), __ccgo_ts+3282)
	}
...
func capture_quantifiers_add_all(tls *libc.TLS, self uintptr, quantifiers uintptr) {
	...
	if (*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize < (*CaptureQuantifiers)(unsafe.Pointer(quantifiers)).Fsize {
		...
		libc.X__builtin___memset_chk(tls, (*CaptureQuantifiers)(unsafe.Pointer(self)).Fcontents+uintptr((*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize), 0, uint64((*CaptureQuantifiers)(unsafe.Pointer(quantifiers)).Fsize-(*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize)*libc.Uint64FromInt64(1), ^__predefined_size_t(0))
	...
	for {
		...
		if libc.BoolInt64(!(uint32(id) < (*CaptureQuantifiers)(unsafe.Pointer(quantifiers)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__39)), __ccgo_ts+2816, int32(868), __ccgo_ts+3312)
		}
		quantifier = (*CaptureQuantifiers)(unsafe.Pointer(quantifiers)).Fcontents + uintptr(id)
		if libc.BoolInt64(!(uint32(id) < (*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__39)), __ccgo_ts+2816, int32(869), __ccgo_ts+3282)
		}
		own_quantifier = (*CaptureQuantifiers)(unsafe.Pointer(self)).Fcontents + uintptr(id)
...
func capture_quantifiers_mul(tls *libc.TLS, self uintptr, quantifier TSQuantifier1) {
	...
	for {
		...
		if libc.BoolInt64(!(uint32(id) < (*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__40)), __ccgo_ts+2816, int32(880), __ccgo_ts+3282)
		}
		own_quantifier = (*CaptureQuantifiers)(unsafe.Pointer(self)).Fcontents + uintptr(id)
...
func capture_quantifiers_join_all(tls *libc.TLS, self uintptr, quantifiers uintptr) {
	...
	for {
		...
		if libc.BoolInt64(!(id < (*CaptureQuantifiers)(unsafe.Pointer(quantifiers)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__41)), __ccgo_ts+2816, int32(894), __ccgo_ts+3312)
		}
		quantifier = (*CaptureQuantifiers)(unsafe.Pointer(quantifiers)).Fcontents + uintptr(id)
		if libc.BoolInt64(!(id < (*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__41)), __ccgo_ts+2816, int32(895), __ccgo_ts+3282)
		}
		own_quantifier = (*CaptureQuantifiers)(unsafe.Pointer(self)).Fcontents + uintptr(id)
	...
	for {
		...
		if libc.BoolInt64(!(id1 < (*CaptureQuantifiers)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__41)), __ccgo_ts+2816, int32(899), __ccgo_ts+3282)
		}
...
func symbol_table_id_for_name(tls *libc.TLS, self uintptr, name uintptr, length uint32_t) (r int32) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__42)), __ccgo_ts+2816, int32(926), __ccgo_ts+3349)
		}
		...
		if v2 = slice.Flength == length; v2 {
			if libc.BoolInt64(!(slice.Foffset < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__42)), __ccgo_ts+2816, int32(929), __ccgo_ts+3387)
			}
		}
...
func symbol_table_name_for_id(tls *libc.TLS, self uintptr, id uint16_t, length uintptr) (r uintptr) {
	var slice Slice
	_ = slice
	if libc.BoolInt64(!(uint32(id) < (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+16)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__43)), __ccgo_ts+2816, int32(940), __ccgo_ts+3440)
	}
	slice = *(*Slice)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	*(*uint32_t)(unsafe.Pointer(length)) = slice.Flength
	if libc.BoolInt64(!(slice.Foffset < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__43)), __ccgo_ts+2816, int32(942), __ccgo_ts+3387)
	}
	return (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func symbol_table_insert_name(tls *libc.TLS, self uintptr, name uintptr, length uint32_t) (r uint16_t) {
	...
	libc.X__builtin___memset_chk(tls, (*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self)).Fsize), 0, uint64(length+libc.Uint32FromInt32(1))*libc.Uint64FromInt64(1), ^__predefined_size_t(0))
...
_1: /**/
	...
	if libc.BoolInt64(!(slice.Foffset < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__44)), __ccgo_ts+2816, int32(957), __ccgo_ts+3387)
	}
	libc.X__builtin___memcpy_chk(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self)).Fcontents+uintptr(slice.Foffset), name, uint64(length), ^__predefined_size_t(0))
	if libc.BoolInt64(!((*SymbolTable)(unsafe.Pointer(self)).Fcharacters.Fsize-libc.Uint32FromInt32(1) < (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__44)), __ccgo_ts+2816, int32(958), __ccgo_ts+3479)
	}
...
func ts_query__pattern_map_search(tls *libc.TLS, self uintptr, needle TSSymbol, result uintptr) (r uint8) {
	...
	for size > uint32(1) {
		...
		if libc.BoolInt64(!(mid_index < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__45)), __ccgo_ts+2816, int32(1253), __ccgo_ts+3545)
		}
		if libc.BoolInt64(!(uint32((*PatternEntry)(unsafe.Pointer((*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__45)), __ccgo_ts+2816, int32(1254), __ccgo_ts+3596)
		}
		if libc.BoolInt64(!(mid_index < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
	...
	if libc.BoolInt64(!(base_index < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__45)), __ccgo_ts+2816, int32(1260), __ccgo_ts+3872)
	}
	if libc.BoolInt64(!(uint32((*PatternEntry)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__45)), __ccgo_ts+2816, int32(1261), __ccgo_ts+3924)
	}
	if libc.BoolInt64(!(base_index < (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	if libc.Int32FromUint16(needle) > libc.Int32FromUint16(symbol) {
		...
		if base_index < (*TSQuery)(unsafe.Pointer(self)).Fpattern_map.Fsize {
			if libc.BoolInt64(!(base_index < (*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__45)), __ccgo_ts+2816, int32(1267), __ccgo_ts+3872)
			}
			if libc.BoolInt64(!(uint32((*PatternEntry)(unsafe.Pointer((*struct {
				Fcontents uintptr
				Fsize     uint32_t
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__45)), __ccgo_ts+2816, int32(1268), __ccgo_ts+4203)
			}
			if libc.BoolInt64(!(base_index < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
...
func ts_query__pattern_map_insert(tls *libc.TLS, self uintptr, symbol TSSymbol, _new_entry PatternEntry) {
	...
	*(*PatternEntry)(unsafe.Pointer(bp)) = _new_entry
	...
	for *(*uint32_t)(unsafe.Pointer(bp + 8)) < (*TSQuery)(unsafe.Pointer(self)).Fpattern_map.Fsize {
		if libc.BoolInt64(!(*(*uint32_t)(unsafe.Pointer(bp + 8)) < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(self+96)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__46)), __ccgo_ts+2816, int32(1291), __ccgo_ts+4482)
		}
		entry = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		if libc.BoolInt64(!(uint32((*PatternEntry)(unsafe.Pointer(entry)).Fstep_index) < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(self+80)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__46)), __ccgo_ts+2816, int32(1293), __ccgo_ts+4529)
		}
	...
	for {
		...
		for {
			...
			if libc.BoolInt64(!(j < (*AnalysisStateSet)(unsafe.Pointer(analysis)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__47)), __ccgo_ts+2816, int32(1373), __ccgo_ts+4582)
			}
			*(*uintptr)(unsafe.Pointer(bp)) = *(*uintptr)(unsafe.Pointer((*AnalysisStateSet)(unsafe.Pointer(analysis)).Fcontents + uintptr(j)*8))
			if (*QueryAnalysis)(unsafe.Pointer(analysis)).Fnext_states.Fsize > uint32(0) {
				if libc.BoolInt64(!((*AnalysisStateSet)(unsafe.Pointer(analysis+16)).Fsize-libc.Uint32FromInt32(1) < (*AnalysisStateSet)(unsafe.Pointer(analysis+16)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__47)), __ccgo_ts+2816, int32(1383), __ccgo_ts+4624)
				}
				...
				if comparison == 0 {
					...
					if comparison > 0 {
						for j < (*QueryAnalysis)(unsafe.Pointer(analysis)).Fstates.Fsize {
							if libc.BoolInt64(!(j < (*AnalysisStateSet)(unsafe.Pointer(analysis)).Fsize)) != 0 {
								libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__47)), __ccgo_ts+2816, int32(1396), __ccgo_ts+4582)
							}
			...
			if libc.BoolInt64(!(uint32((*AnalysisState)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp)))).Fstep_index) < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+80)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__47)), __ccgo_ts+2816, int32(1408), __ccgo_ts+4704)
			}
			step = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
		...
		_3: /**/
			...
			if libc.BoolInt64(!(*(*uint32)(unsafe.Pointer(bp + 8)) < (*AnalysisSubgraphArray)(unsafe.Pointer(subgraphs)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__47)), __ccgo_ts+2816, int32(1413), __ccgo_ts+4757)
			}
			...
			*(*LookaheadIterator)(unsafe.Pointer(bp + 16)) = ts_language_lookaheads(tls, (*TSQuery)(unsafe.Pointer(self)).Flanguage, parse_state)
			...
			_5: /**/
				...
				for *(*uint32)(unsafe.Pointer(bp + 80)) < (*AnalysisSubgraph)(unsafe.Pointer(subgraph)).Fnodes.Fsize {
					if libc.BoolInt64(!(*(*uint32)(unsafe.Pointer(bp + 80)) < (*struct {
						Fcontents uintptr
						Fsize     uint32_t
						Fcapacity uint32_t
					})(unsafe.Pointer(subgraph+24)).Fsize)) != 0 {
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__47)), __ccgo_ts+2816, int32(1449), __ccgo_ts+4804)
					}
					node = (*struct {
						Fcontents uintptr
						Fsize     uint32_t
					...
					*(*AnalysisState)(unsafe.Pointer(bp + 104)) = *(*AnalysisState)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp))))
					...
					if does_match != 0 {
						for {
							...
							if libc.BoolInt64(!(uint32((*(*AnalysisState)(unsafe.Pointer(bp + 104))).Fstep_index) < (*struct {
								Fcontents uintptr
								Fsize     uint32_t
								Fcapacity uint32_t
							})(unsafe.Pointer(self+80)).Fsize)) != 0 {
								libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__47)), __ccgo_ts+2816, int32(1556), __ccgo_ts+4854)
							}
							next_step = (*struct {
								Fcontents uintptr
								Fsize     uint32_t
					...
					for {
						...
						if !(int32(*(*uint8)(unsafe.Pointer(next_step + 18))&0x10>>4) != 0) {
							if libc.BoolInt64(!(uint32((*(*AnalysisState)(unsafe.Pointer(bp + 104))).Fstep_index) < (*struct {
								...
								libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__47)), __ccgo_ts+2816, int32(1580), __ccgo_ts+4854)
							}
						...
						if does_match != 0 && libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(next_step)).Falternative_index) != libc.Int32FromUint16(NONE) && libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(next_step)).Falternative_index) > libc.Int32FromUint16((*(*AnalysisState)(unsafe.Pointer(bp + 104))).Fstep_index) {
							...
							if libc.BoolInt64(!(uint32((*(*AnalysisState)(unsafe.Pointer(bp + 104))).Fstep_index) < (*struct {
								...
								libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__47)), __ccgo_ts+2816, int32(1600), __ccgo_ts+4854)
							}
							next_step = (*struct {
								Fcontents uintptr
								Fsize     uint32_t
...
func ts_query__analyze_patterns(tls *libc.TLS, self uintptr, error_offset uintptr) (r uint8) {
	...
	*(*struct {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1656), __ccgo_ts+4911)
		}
		pattern = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		if !((*PatternEntry)(unsafe.Pointer(pattern)).Fis_rooted != 0) {
			if libc.BoolInt64(!(uint32((*PatternEntry)(unsafe.Pointer(pattern)).Fstep_index) < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+80)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1658), __ccgo_ts+4954)
			}
			step = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
	...
	*(*struct {
	...
	for {
		...
		if libc.BoolInt64(!(i1 < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1671), __ccgo_ts+5009)
		}
		step1 = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		for {
			...
			if libc.BoolInt64(!(j < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+80)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1682), __ccgo_ts+5046)
			}
			next_step = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				...
				*(*uint32_t)(unsafe.Pointer((*struct {
				...
				if (*QueryStep)(unsafe.Pointer(step1)).Fsupertype_symbol != 0 && (*TSLanguage)(unsafe.Pointer((*TSQuery)(unsafe.Pointer(self)).Flanguage)).Fabi_version >= uint32(15) {
					...
					for {
						...
						if libc.BoolInt64(!(j1 < (*struct {
							Fcontents uintptr
							Fsize     uint32_t
							Fcapacity uint32_t
						})(unsafe.Pointer(self+80)).Fsize)) != 0 {
							libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1710), __ccgo_ts+5046)
						}
						child_step = (*struct {
							Fcontents uintptr
							Fsize     uint32_t
						...
						if libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(child_step)).Fdepth) == libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(step1)).Fdepth)+int32(1) && libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(child_step)).Fsymbol) != libc.Int32FromUint16(WILDCARD_SYMBOL) {
							...
							if !(is_valid_subtype != 0) {
								...
								for {
									...
									if libc.BoolInt64(!(offset_idx < (*struct {
										Fcontents uintptr
										Fsize     uint32_t
										Fcapacity uint32_t
									})(unsafe.Pointer(self+144)).Fsize)) != 0 {
										libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1725), __ccgo_ts+5083)
									}
									step_offset = (*struct {
										Fcontents uintptr
										Fsize     uint32_t
	...
	*(*AnalysisSubgraphArray)(unsafe.Pointer(bp + 184)) = AnalysisSubgraphArray{}
	...
	for {
		...
		if libc.BoolInt64(!(i2 < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(bp+160)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1749), __ccgo_ts+5136)
		}
		...
		if libc.BoolInt64(!(parent_step_index < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(self+80)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1750), __ccgo_ts+5181)
		}
						...
						_20: /**/
							...
							if *(*uint32)(unsafe.Pointer(bp + 308)) != 0 {
								if libc.BoolInt64(!(*(*uint32)(unsafe.Pointer(bp + 304)) < (*AnalysisSubgraphArray)(unsafe.Pointer(bp+184)).Fsize)) != 0 {
									libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1792), __ccgo_ts+5234)
								}
								...
								if v22 = (*AnalysisSubgraph)(unsafe.Pointer(subgraph2)).Fnodes.Fsize == uint32(0); !v22 {
									if libc.BoolInt64(!((*struct {
										...
										libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1793), __ccgo_ts+5282)
									}
								}
				...
				if libc.Int32FromUint16((*(*LookaheadIterator)(unsafe.Pointer(bp + 312))).Fnext_state) != 0 {
					...
					if ts_language_state_is_primary(tls, (*TSQuery)(unsafe.Pointer(self)).Flanguage, state) != 0 {
						...
						_26: /**/
							...
							if *(*uint32)(unsafe.Pointer(bp + 308)) != 0 {
								if libc.BoolInt64(!(*(*uint32)(unsafe.Pointer(bp + 304)) < (*AnalysisSubgraphArray)(unsafe.Pointer(bp+184)).Fsize)) != 0 {
									libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1829), __ccgo_ts+5234)
								}
								...
								if v22 = (*AnalysisSubgraph)(unsafe.Pointer(subgraph3)).Fstart_states.Fsize == uint32(0); !v22 {
									if libc.BoolInt64(!((*struct {
										...
										libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1832), __ccgo_ts+5350)
									}
								}
	...
	*(*struct {
	...
	for {
		...
		if libc.BoolInt64(!(i4 < (*AnalysisSubgraphArray)(unsafe.Pointer(bp+184)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1846), __ccgo_ts+5432)
		}
	...
	*(*QueryAnalysis)(unsafe.Pointer(bp + 448)) = query_analysis__new(tls)
	...
	for {
		...
		if libc.BoolInt64(!(i5 < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(bp+160)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1910), __ccgo_ts+5136)
		}
		...
		if libc.BoolInt64(!(uint32(parent_step_index1) < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(self+80)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1911), __ccgo_ts+5181)
		}
		...
		if libc.BoolInt64(!(uint32(parent_step_index1) < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1912), __ccgo_ts+5181)
		}
	...
	_40: /**/
		...
		_42: /**/
			...
			if libc.BoolInt64(!(*(*uint32_t)(unsafe.Pointer(bp + 564)) != 0)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1923), __ccgo_ts+5467)
			}
			if libc.BoolInt64(!(*(*uint32_t)(unsafe.Pointer(bp + 560)) < (*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1924), __ccgo_ts+5480)
			}
		...
		if libc.BoolInt64(!(*(*uint32)(unsafe.Pointer(bp + 552)) < (*AnalysisSubgraphArray)(unsafe.Pointer(bp+184)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1931), __ccgo_ts+5234)
		}
		...
		for {
			...
			if libc.BoolInt64(!(j4 < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(subgraph5+8)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1935), __ccgo_ts+5524)
			}
		...
		if (*(*QueryAnalysis)(unsafe.Pointer(bp + 448))).Fdid_abort != 0 {
			...
			for {
				...
				if libc.BoolInt64(!(j5 < (*struct {
					Fcontents uintptr
					Fsize     uint32_t
					Fcapacity uint32_t
				})(unsafe.Pointer(self+80)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1966), __ccgo_ts+5046)
				}
				step2 = (*struct {
					Fcontents uintptr
					Fsize     uint32_t
		...
		if (*(*QueryAnalysis)(unsafe.Pointer(bp + 448))).Ffinished_parent_symbols.Fsize == uint32(0) {
			if (*(*QueryAnalysis)(unsafe.Pointer(bp + 448))).Ffinal_step_indices.Fsize > uint32(0) {
				if libc.BoolInt64(!((*struct {
					...
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1984), __ccgo_ts+5572)
				}
		...
		_46: /**/
			...
			if libc.BoolInt64(!(*(*uint32_t)(unsafe.Pointer(bp + 568)) < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+144)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(1992), __ccgo_ts+5480)
			}
			*(*uint32)(unsafe.Pointer(error_offset)) = (*StepOffset)(unsafe.Pointer((*struct {
				Fcontents uintptr
				Fsize     uint32_t
		...
		for {
			...
			if libc.BoolInt64(!(j7 < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(bp+448+64)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2000), __ccgo_ts+5664)
			}
			...
			if libc.BoolInt64(!(final_step_index < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+80)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2001), __ccgo_ts+5717)
			}
			step3 = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
	...
	*(*struct {
	...
	for {
		...
		if libc.BoolInt64(!(i6 < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(self+128)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2016), __ccgo_ts+5769)
		}
		pattern1 = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		for {
			...
			if libc.BoolInt64(!(j8 < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+112)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2025), __ccgo_ts+5809)
			}
			step4 = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
		...
		for {
			...
			if libc.BoolInt64(!(j9 < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+80)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2038), __ccgo_ts+5046)
			}
			step5 = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
	...
	for !(done != 0) {
		...
		for {
			...
			if libc.BoolInt64(!(i7 < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+80)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2058), __ccgo_ts+5009)
			}
			step6 = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
			...
			for {
				...
				if libc.BoolInt64(!(uint32((*QueryStep)(unsafe.Pointer(step6)).Falternative_index) < (*struct {
					Fcontents uintptr
					Fsize     uint32_t
					Fcapacity uint32_t
				})(unsafe.Pointer(self+80)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2071), __ccgo_ts+5856)
				}
				step6 = (*struct {
					Fcontents uintptr
					Fsize     uint32_t
			...
			if !(parent_pattern_guaranteed != 0) {
				if libc.BoolInt64(!(i7-libc.Uint32FromInt32(1) < (*struct {
					Fcontents uintptr
					Fsize     uint32_t
					Fcapacity uint32_t
				})(unsafe.Pointer(self+80)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2076), __ccgo_ts+5915)
				}
				prev_step = (*struct {
					Fcontents uintptr
					Fsize     uint32_t
	...
	for {
		...
		if libc.BoolInt64(!(i8 < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(bp+144)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2098), __ccgo_ts+5956)
		}
		...
		if libc.BoolInt64(!(uint32(pattern_entry_index) < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(self+96)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2099), __ccgo_ts+6012)
		}
		...
		for {
			...
			if libc.BoolInt64(!(j10 < (*AnalysisSubgraphArray)(unsafe.Pointer(bp+184)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2104), __ccgo_ts+6073)
			}
			...
			for {
				...
				if libc.BoolInt64(!(k2 < (*struct {
					Fcontents uintptr
					Fsize     uint32_t
					Fcapacity uint32_t
				})(unsafe.Pointer(subgraph6+8)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2109), __ccgo_ts+6108)
				}
		...
		ts_query__perform_analysis(tls, self, bp+184, bp+448)
		if (*(*QueryAnalysis)(unsafe.Pointer(bp + 448))).Ffinished_parent_symbols.Fsize > uint32(0) {
			if libc.BoolInt64(!(uint32((*PatternEntry)(unsafe.Pointer(pattern_entry)).Fpattern_index) < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+128)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2138), __ccgo_ts+6156)
			}
		...
		for {
			...
			if libc.BoolInt64(!(k3 < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(bp+448+80)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2142), __ccgo_ts+6223)
			}
	...
	for {
		...
		if libc.BoolInt64(!(i9 < (*AnalysisSubgraphArray)(unsafe.Pointer(bp+184)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2161), __ccgo_ts+5432)
		}
		if (*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		if libc.BoolInt64(!(i9 < (*AnalysisSubgraphArray)(unsafe.Pointer(bp+184)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__48)), __ccgo_ts+2816, int32(2162), __ccgo_ts+5432)
		}
		if (*struct {
			Fcontents uintptr
			Fsize     uint32_t
...
func ts_query__add_negated_fields(tls *libc.TLS, self uintptr, step_index uint16_t, field_ids uintptr, field_count uint16_t) {
	...
	if libc.BoolInt64(!(uint32(step_index) < (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+80)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__49)), __ccgo_ts+2816, int32(2183), __ccgo_ts+6281)
	}
	step = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__49)), __ccgo_ts+2816, int32(2191), __ccgo_ts+6327)
		}
...
func ts_query__parse_pattern(tls *libc.TLS, self uintptr, stream uintptr, depth uint32_t, is_immediate uint8, is_inside_alternation uint8, capture_quantifiers uintptr) (r TSQueryError1) {
	...
	if v1 = (*TSQuery)(unsafe.Pointer(self)).Fstep_offsets.Fsize == uint32(0); !v1 {
		if libc.BoolInt64(!((*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2412), __ccgo_ts+6373)
		}
	}
	...
	if (*Stream)(unsafe.Pointer(stream)).Fnext == int32('[') {
		...
		*(*CaptureQuantifiers)(unsafe.Pointer(bp + 16)) = capture_quantifiers_new(tls)
		for {
			...
			e = ts_query__parse_pattern(tls, self, stream, depth, is_immediate, libc.BoolUint8(1 != 0), bp+16)
			if e == PARENT_DONE {
		...
		*(*uint32_t)(unsafe.Pointer(v3)) = *(*uint32_t)(unsafe.Pointer(v3)) - 1
		...
		for {
			...
			if libc.BoolInt64(!(i < (*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2467), __ccgo_ts+6447)
			}
			...
			if libc.BoolInt64(!(i+libc.Uint32FromInt32(1) < (*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2468), __ccgo_ts+6492)
			}
			...
			if libc.BoolInt64(!(step_index < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+80)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2469), __ccgo_ts+6281)
			}
			start_step = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
			...
			if libc.BoolInt64(!(next_step_index-libc.Uint32FromInt32(1) < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+80)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2470), __ccgo_ts+6541)
			}
			end_step = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
			...
			if (*Stream)(unsafe.Pointer(stream)).Fnext == int32('(') || (*Stream)(unsafe.Pointer(stream)).Fnext == int32('"') || (*Stream)(unsafe.Pointer(stream)).Fnext == int32('[') {
				...
				*(*CaptureQuantifiers)(unsafe.Pointer(bp + 32)) = capture_quantifiers_new(tls)
				for {
					...
					e1 = ts_query__parse_pattern(tls, self, stream, depth, child_is_immediate, is_inside_alternation, bp+32)
					if e1 == PARENT_DONE {
						if (*Stream)(unsafe.Pointer(stream)).Fnext == int32(')') {
							stream_advance(tls, stream)
							break
				...
				if (*Stream)(unsafe.Pointer(stream)).Fnext == int32('.') || (*Stream)(unsafe.Pointer(stream)).Fnext == int32('#') {
					...
					if stream_is_ident_start(tls, stream) != 0 {
						...
						if length == uint32(1) && int32(*(*int8)(unsafe.Pointer(node_name))) == int32('_') {
							...
							if !(libc.Xstrncmp(tls, node_name, __ccgo_ts+6596, uint64(length)) != 0) {
					...
					*(*QueryStep)(unsafe.Pointer((*struct {
					...
					if libc.BoolInt64(!((*struct {
						...
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2619), __ccgo_ts+6604)
					}
					step = (*struct {
						Fcontents uintptr
						Fsize     uint32_t
					...
					*(*CaptureQuantifiers)(unsafe.Pointer(bp + 72)) = capture_quantifiers_new(tls)
					for {
						...
						e4 = ts_query__parse_pattern(tls, self, stream, depth+uint32(1), child_is_immediate1, is_inside_alternation, bp+72)
						...
						if e4 == PARENT_DONE {
							if (*Stream)(unsafe.Pointer(stream)).Fnext == int32(')') {
								if child_is_immediate1 != 0 {
									...
									if libc.BoolInt64(!(uint32(last_child_step_index) < (*struct {
										Fcontents uintptr
										Fsize     uint32_t
										Fcapacity uint32_t
									})(unsafe.Pointer(self+80)).Fsize)) != 0 {
										libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2764), __ccgo_ts+6664)
									}
									...
									if libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(last_child_step)).Falternative_index) != libc.Int32FromUint16(NONE) && uint32((*QueryStep)(unsafe.Pointer(last_child_step)).Falternative_index) < (*TSQuery)(unsafe.Pointer(self)).Fsteps.Fsize {
										if libc.BoolInt64(!(uint32((*QueryStep)(unsafe.Pointer(last_child_step)).Falternative_index) < (*struct {
											Fcontents uintptr
											Fsize     uint32_t
											Fcapacity uint32_t
										})(unsafe.Pointer(self+80)).Fsize)) != 0 {
											libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2770), __ccgo_ts+6721)
										}
										...
										for libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(alternative_step)).Falternative_index) != libc.Int32FromUint16(NONE) && uint32((*QueryStep)(unsafe.Pointer(alternative_step)).Falternative_index) < (*TSQuery)(unsafe.Pointer(self)).Fsteps.Fsize {
											if libc.BoolInt64(!(uint32((*QueryStep)(unsafe.Pointer(alternative_step)).Falternative_index) < (*struct {
												Fcontents uintptr
												Fsize     uint32_t
												Fcapacity uint32_t
											})(unsafe.Pointer(self+80)).Fsize)) != 0 {
												libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2776), __ccgo_ts+6791)
											}
											alternative_step = (*struct {
												Fcontents uintptr
												Fsize     uint32_t
					...
					*(*QueryStep)(unsafe.Pointer((*struct {
					...
					if stream_is_ident_start(tls, stream) != 0 {
						...
						*(*CaptureQuantifiers)(unsafe.Pointer(bp + 88)) = capture_quantifiers_new(tls)
						e6 = ts_query__parse_pattern(tls, self, stream, depth, is_immediate, is_inside_alternation, bp+88)
						if e6 != 0 {
						...
						if libc.BoolInt64(!(step_index2 < (*struct {
							Fcontents uintptr
							Fsize     uint32_t
							Fcapacity uint32_t
						})(unsafe.Pointer(self+80)).Fsize)) != 0 {
							libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2883), __ccgo_ts+6281)
						}
						step1 = (*struct {
							Fcontents uintptr
							Fsize     uint32_t
						...
						for {
							...
							if libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(step1)).Falternative_index) != libc.Int32FromUint16(NONE) && uint32((*QueryStep)(unsafe.Pointer(step1)).Falternative_index) > step_index2 && uint32((*QueryStep)(unsafe.Pointer(step1)).Falternative_index) < (*TSQuery)(unsafe.Pointer(self)).Fsteps.Fsize {
								...
								if libc.BoolInt64(!(step_index2 < (*struct {
									...
									libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2892), __ccgo_ts+6281)
								}
								step1 = (*struct {
									Fcontents uintptr
									Fsize     uint32_t
			...
			if (*Stream)(unsafe.Pointer(stream)).Fnext == int32('*') {
				...
				if (*Stream)(unsafe.Pointer(stream)).Fnext == int32('?') {
					...
					if (*Stream)(unsafe.Pointer(stream)).Fnext == int32('@') {
						...
						for {
							if libc.BoolInt64(!(step_index3 < (*struct {
								Fcontents uintptr
								Fsize     uint32_t
								Fcapacity uint32_t
							})(unsafe.Pointer(self+80)).Fsize)) != 0 {
								libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2956), __ccgo_ts+6281)
							}
							step2 = (*struct {
								Fcontents uintptr
								Fsize     uint32_t
	...
	case int32(TSQuantifierOneOrMore):
		*(*QueryStep)(unsafe.Pointer(bp + 104)) = query_step__new(tls, WILDCARD_SYMBOL, uint16(depth), libc.BoolUint8(0 != 0))
		libc.SetBitFieldPtr8Uint8(bp+104+18, is_inside_alternation, 5, 0x20)
	...
	case int32(TSQuantifierZeroOrMore):
		...
		*(*QueryStep)(unsafe.Pointer((*struct {
		...
		if libc.BoolInt64(!(starting_step_index < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(self+80)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2996), __ccgo_ts+6862)
		}
		step3 = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		for libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(step3)).Falternative_index) != libc.Int32FromUint16(NONE) && uint32((*QueryStep)(unsafe.Pointer(step3)).Falternative_index) < (*TSQuery)(unsafe.Pointer(self)).Fsteps.Fsize-uint32(1) {
			if libc.BoolInt64(!(uint32((*QueryStep)(unsafe.Pointer(step3)).Falternative_index) < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+80)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(2998), __ccgo_ts+5856)
			}
			step3 = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
	...
	case int32(TSQuantifierZeroOrOne):
		if libc.BoolInt64(!(starting_step_index < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(3004), __ccgo_ts+6862)
		}
		step3 = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		for libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(step3)).Falternative_index) != libc.Int32FromUint16(NONE) && uint32((*QueryStep)(unsafe.Pointer(step3)).Falternative_index) < (*TSQuery)(unsafe.Pointer(self)).Fsteps.Fsize {
			if libc.BoolInt64(!(uint32((*QueryStep)(unsafe.Pointer(step3)).Falternative_index) < (*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__50)), __ccgo_ts+2816, int32(3006), __ccgo_ts+5856)
			}
			step3 = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
...
func ts_query_new(tls *libc.TLS, language uintptr, source uintptr, source_len uint32_t, error_offset uintptr, error_type uintptr) (r uintptr) {
	...
	*(*Stream)(unsafe.Pointer(bp)) = stream_new(tls, source, source_len)
	...
	for (*(*Stream)(unsafe.Pointer(bp))).Finput < (*(*Stream)(unsafe.Pointer(bp))).Fend {
		...
		*(*CaptureQuantifiers)(unsafe.Pointer(bp + 32)) = capture_quantifiers_new(tls)
		*(*TSQueryError1)(unsafe.Pointer(error_type)) = ts_query__parse_pattern(tls, self, bp, uint32(0), libc.BoolUint8(0 != 0), libc.BoolUint8(0 != 0), bp+32)
		(*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		...
		*(*QueryStep)(unsafe.Pointer((*struct {
		...
		if libc.BoolInt64(!((*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__51)), __ccgo_ts+2816, int32(3072), __ccgo_ts+6917)
		}
		pattern = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		*(*CaptureQuantifiers)(unsafe.Pointer((*struct {
		...
		for {
			if libc.BoolInt64(!(start_step_index < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+80)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__51)), __ccgo_ts+2816, int32(3093), __ccgo_ts+6983)
			}
			step = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
			...
			if libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(step)).Fsymbol) == libc.Int32FromUint16(WILDCARD_SYMBOL) && libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(step)).Fdepth) == 0 && !((*QueryStep)(unsafe.Pointer(step)).Ffield != 0) {
				if libc.BoolInt64(!(start_step_index+libc.Uint32FromInt32(1) < (*struct {
					Fcontents uintptr
					Fsize     uint32_t
					Fcapacity uint32_t
				})(unsafe.Pointer(self+80)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__51)), __ccgo_ts+2816, int32(3100), __ccgo_ts+7035)
				}
				second_step = (*struct {
					Fcontents uintptr
					Fsize     uint32_t
			...
			for {
				...
				if libc.BoolInt64(!(step_index < (*struct {
					...
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__51)), __ccgo_ts+2816, int32(3115), __ccgo_ts+6281)
				}
				child_step = (*struct {
					Fcontents uintptr
					Fsize     uint32_t
		...
		for {
			...
			if libc.BoolInt64(!(i < (*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__51)), __ccgo_ts+2816, int32(3157), __ccgo_ts+5009)
			}
			s = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
			...
			if libc.BoolInt64(!(target_idx < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+80)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__51)), __ccgo_ts+2816, int32(3163), __ccgo_ts+7091)
			}
			target = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
			...
			*(*QueryStep)(unsafe.Pointer((*struct {
			...
			if libc.BoolInt64(!(i < (*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__51)), __ccgo_ts+2816, int32(3186), __ccgo_ts+5009)
			}
			s = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
...
func ts_query_delete(tls *libc.TLS, self uintptr) {
	...
	if self != 0 {
		...
		for {
			...
			if libc.BoolInt64(!(index < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+64)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__52)), __ccgo_ts+2816, int32(3224), __ccgo_ts+7137)
			}
...
func ts_query_copy(tls *libc.TLS, self uintptr) (r uintptr) {
	...
	copy1 = (*(*func(*libc.TLS, size_t) uintptr)(unsafe.Pointer(&struct{ uintptr }{ts_current_malloc})))(tls, uint64(224))
	*(*TSQuery)(unsafe.Pointer(copy1)) = TSQuery{
	...
	(*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1 + 80)).Fcontents = _array__assign(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1+80)).Fcontents, copy1+80+8, copy1+80+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+80)).Fcontents, (*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+80)).Fsize, libc.Uint64FromInt64(20))
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1+96)).Fcontents, copy1+96+8, copy1+96+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+96)).Fsize, libc.Uint64FromInt64(6))
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1 + 112)).Fcontents = _array__assign(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1+112)).Fcontents, copy1+112+8, copy1+112+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+112)).Fcontents, (*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+112)).Fsize, libc.Uint64FromInt64(8))
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1 + 128)).Fcontents = _array__assign(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1+128)).Fcontents, copy1+128+8, copy1+128+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+128)).Fcontents, (*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+128)).Fsize, libc.Uint64FromInt64(28))
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1+144)).Fcontents, copy1+144+8, copy1+144+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+144)).Fcontents, (*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+144)).Fsize, libc.Uint64FromInt64(8))
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1 + 160)).Fcontents = _array__assign(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1+160)).Fcontents, copy1+160+8, copy1+160+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+160)).Fcontents, (*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+160)).Fsize, libc.Uint64FromInt64(2))
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1 + 176)).Fcontents = _array__assign(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1+176)).Fcontents, copy1+176+8, copy1+176+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+176)).Fcontents, (*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+176)).Fsize, libc.Uint64FromInt64(1))
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1 + 192)).Fcontents = _array__assign(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1+192)).Fcontents, copy1+192+8, copy1+192+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+192)).Fcontents, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+192)).Fsize, libc.Uint64FromInt64(2))
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1)).Fcontents, copy1+8, copy1+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self)).Fcontents, (*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self)).Fsize, libc.Uint64FromInt64(1))
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1 + 16)).Fcontents = _array__assign(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1+16)).Fcontents, copy1+16+8, copy1+16+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+16)).Fcontents, (*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+16)).Fsize, libc.Uint64FromInt64(8))
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1 + 32)).Fcontents = _array__assign(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1+32)).Fcontents, copy1+32+8, copy1+32+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+32)).Fsize, libc.Uint64FromInt64(1))
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1 + 32 + 16)).Fcontents = _array__assign(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1+32+16)).Fcontents, copy1+32+16+8, copy1+32+16+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+32+16)).Fcontents, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+32+16)).Fsize, libc.Uint64FromInt64(8))
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1 + 64)).Fcontents = _array__assign(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(copy1+64)).Fcontents, copy1+64+8, copy1+64+12, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+64)).Fcontents, (*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+64)).Fsize, libc.Uint64FromInt64(16))
	i = uint32(0)
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__53)), __ccgo_ts+2816, int32(3256), __ccgo_ts+7192)
		}
		dst = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(copy1+64)).Fcontents + uintptr(i)*16
		if libc.BoolInt64(!(i < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(self+64)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__53)), __ccgo_ts+2816, int32(3257), __ccgo_ts+7243)
		}
		src = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(self+64)).Fcontents + uintptr(i)*16
		*(*CaptureQuantifiers)(unsafe.Pointer(dst)) = capture_quantifiers_new(tls)
		(*CaptureQuantifiers)(unsafe.Pointer(dst)).Fcontents = _array__assign(tls, (*CaptureQuantifiers)(unsafe.Pointer(dst)).Fcontents, dst+8, dst+12, (*CaptureQuantifiers)(unsafe.Pointer(src)).Fcontents, (*CaptureQuantifiers)(unsafe.Pointer(src)).Fsize, libc.Uint64FromInt64(1))
		goto _1
	_1:
		;
		i = i + 1
...
func ts_query_capture_quantifier_for_id(tls *libc.TLS, self uintptr, pattern_index uint32_t, capture_index uint32_t) (r TSQuantifier1) {
	...
	if libc.BoolInt64(!(pattern_index < (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+64)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__54)), __ccgo_ts+2816, int32(3290), __ccgo_ts+7294)
	}
	capture_quantifiers = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_query_predicates_for_pattern(tls *libc.TLS, self uintptr, pattern_index uint32_t, step_count uintptr) (r uintptr) {
	...
	if libc.BoolInt64(!(pattern_index < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__55)), __ccgo_ts+2816, int32(3307), __ccgo_ts+7357)
	}
	...
	*(*uint32_t)(unsafe.Pointer(step_count)) = slice.Flength
	...
	if libc.BoolInt64(!(slice.Foffset < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__55)), __ccgo_ts+2816, int32(3310), __ccgo_ts+7409)
	}
	return (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_query_start_byte_for_pattern(tls *libc.TLS, self uintptr, pattern_index uint32_t) (r uint32_t) {
	if libc.BoolInt64(!(pattern_index < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__56)), __ccgo_ts+2816, int32(3317), __ccgo_ts+7357)
	}
...
func ts_query_end_byte_for_pattern(tls *libc.TLS, self uintptr, pattern_index uint32_t) (r uint32_t) {
	if libc.BoolInt64(!(pattern_index < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__57)), __ccgo_ts+2816, int32(3324), __ccgo_ts+7357)
	}
	return (*QueryPattern)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_query_is_pattern_rooted(tls *libc.TLS, self uintptr, pattern_index uint32_t) (r uint8) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__58)), __ccgo_ts+2816, int32(3332), __ccgo_ts+4911)
		}
		entry = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
...
func ts_query_is_pattern_non_local(tls *libc.TLS, self uintptr, pattern_index uint32_t) (r uint8) {
	if pattern_index < (*TSQuery)(unsafe.Pointer(self)).Fpatterns.Fsize {
		if libc.BoolInt64(!(pattern_index < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__59)), __ccgo_ts+2816, int32(3345), __ccgo_ts+7357)
		}
		return (*QueryPattern)(unsafe.Pointer((*struct {
			Fcontents uintptr
			Fsize     uint32_t
...
func ts_query_is_pattern_guaranteed_at_step(tls *libc.TLS, self uintptr, byte_offset uint32_t) (r uint8) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__60)), __ccgo_ts+2816, int32(3357), __ccgo_ts+7467)
		}
		step_offset = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
	...
	if step_index < (*TSQuery)(unsafe.Pointer(self)).Fsteps.Fsize {
		if libc.BoolInt64(!(step_index < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__60)), __ccgo_ts+2816, int32(3362), __ccgo_ts+6281)
		}
...
func ts_query__step_is_fallible(tls *libc.TLS, self uintptr, step_index uint16_t) (r uint8) {
	...
	if libc.BoolInt64(!(uint32(step_index) < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__61)), __ccgo_ts+2816, int32(3373), __ccgo_ts+6281)
	}
	step = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	for cond := true; cond; cond = int32(*(*uint8)(unsafe.Pointer(next_step + 18))&0x8>>3) != 0 {
		if libc.BoolInt64(!(uint32(step_index)+i < (*TSQuery)(unsafe.Pointer(self)).Fsteps.Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__61)), __ccgo_ts+2816, int32(3376), __ccgo_ts+7511)
		}
		if libc.BoolInt64(!(uint32(step_index)+i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__61)), __ccgo_ts+2816, int32(3377), __ccgo_ts+7555)
		}
		next_step = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(self+80)).Fcontents + uintptr(uint32(step_index)+i)*20
		i = i + 1
	}
	...
	if id != -int32(1) {
		...
		for {
			...
			if libc.BoolInt64(!(i < (*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__62)), __ccgo_ts+2816, int32(3398), __ccgo_ts+5009)
			}
			step = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
...
func ts_query_disable_pattern(tls *libc.TLS, self uintptr, pattern_index uint32_t) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__63)), __ccgo_ts+2816, int32(3411), __ccgo_ts+4911)
		}
		pattern = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
...
func ts_query_cursor_new(tls *libc.TLS) (r uintptr) {
	var self uintptr
	_ = self
	self = (*(*func(*libc.TLS, size_t) uintptr)(unsafe.Pointer(&struct{ uintptr }{ts_current_malloc})))(tls, uint64(216))
	*(*TSQueryCursor)(unsafe.Pointer(self)) = TSQueryCursor{
		Fcapture_list_pool: capture_list_pool_new(tls),
		Fmax_start_depth:   uint32(4294967295),
		Fincluded_range: TSRange{
			Fend_point: TSPoint{
				Frow:    uint32(4294967295),
				Fcolumn: uint32(4294967295),
	...
	(*QueryStateList)(unsafe.Pointer(self + 40)).Fcontents = _array__reserve(tls, (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents, self+40+12, libc.Uint64FromInt64(24), uint32(8))
	(*QueryStateList)(unsafe.Pointer(self + 56)).Fcontents = _array__reserve(tls, (*QueryStateList)(unsafe.Pointer(self+56)).Fcontents, self+56+12, libc.Uint64FromInt64(24), uint32(8))
	return self
}

func ts_query_cursor_delete(tls *libc.TLS, self uintptr) {
	if (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{ts_current_free})))(tls, (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents)
	}
	(*QueryStateList)(unsafe.Pointer(self + 40)).Fcontents = libc.UintptrFromInt32(0)
	(*QueryStateList)(unsafe.Pointer(self + 40)).Fsize = uint32(0)
	(*QueryStateList)(unsafe.Pointer(self + 40)).Fcapacity = uint32(0)
	if (*QueryStateList)(unsafe.Pointer(self+56)).Fcontents != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{ts_current_free})))(tls, (*QueryStateList)(unsafe.Pointer(self+56)).Fcontents)
	}
	(*QueryStateList)(unsafe.Pointer(self + 56)).Fcontents = libc.UintptrFromInt32(0)
	(*QueryStateList)(unsafe.Pointer(self + 56)).Fsize = uint32(0)
	(*QueryStateList)(unsafe.Pointer(self + 56)).Fcapacity = uint32(0)
	ts_tree_cursor_delete(tls, self+8)
	capture_list_pool_delete(tls, self+80)
	(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{ts_current_free})))(tls, self)
}
...
func ts_query_cursor_exec(tls *libc.TLS, self uintptr, query uintptr, node TSNode) {
	...
	if query != 0 {
		...
		for {
			...
			if libc.BoolInt64(!(i < (*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__64)), __ccgo_ts+2816, int32(3486), __ccgo_ts+7605)
			}
			step = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
	...
	capture_list_pool_reset(tls, self+80)
...
func ts_query_cursor__first_in_progress_capture(tls *libc.TLS, self uintptr, state_index uintptr, byte_offset uintptr, pattern_index uintptr, is_definite uintptr) (r uint8) {
	...
	*(*uint32_t)(unsafe.Pointer(state_index)) = uint32(4294967295)
	*(*uint32_t)(unsafe.Pointer(byte_offset)) = uint32(4294967295)
	*(*uint32_t)(unsafe.Pointer(pattern_index)) = uint32(4294967295)
	i = uint32(0)
	for {
		...
		if libc.BoolInt64(!(i < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__65)), __ccgo_ts+2816, int32(3620), __ccgo_ts+7643)
		}
		...
		if libc.BoolInt64(!(libc.Uint32FromInt32(int32(*(*uint16)(unsafe.Pointer(state + 18))&0xfff>>0)) < (*CaptureList)(unsafe.Pointer(captures)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__65)), __ccgo_ts+2816, int32(3631), __ccgo_ts+7681)
		}
		...
		if !(result != 0) || node_start_byte < *(*uint32_t)(unsafe.Pointer(byte_offset)) || node_start_byte == *(*uint32_t)(unsafe.Pointer(byte_offset)) && uint32((*QueryState)(unsafe.Pointer(state)).Fpattern_index) < *(*uint32_t)(unsafe.Pointer(pattern_index)) {
			if libc.BoolInt64(!(uint32((*QueryState)(unsafe.Pointer(state)).Fstep_index) < (*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__65)), __ccgo_ts+2816, int32(3647), __ccgo_ts+7742)
			}
			step = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
...
func ts_query_cursor__compare_captures(tls *libc.TLS, self uintptr, left_state uintptr, right_state uintptr, left_contains_right uintptr, right_contains_left uintptr) {
	...
	left_captures = capture_list_pool_get(tls, self+80, (*QueryState)(unsafe.Pointer(left_state)).Fcapture_list_id)
	right_captures = capture_list_pool_get(tls, self+80, (*QueryState)(unsafe.Pointer(right_state)).Fcapture_list_id)
		...
		if i < (*CaptureList)(unsafe.Pointer(left_captures)).Fsize {
			if j < (*CaptureList)(unsafe.Pointer(right_captures)).Fsize {
				if libc.BoolInt64(!(i < (*CaptureList)(unsafe.Pointer(left_captures)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__66)), __ccgo_ts+2816, int32(3703), __ccgo_ts+7802)
				}
				...
				if libc.BoolInt64(!(j < (*CaptureList)(unsafe.Pointer(right_captures)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__66)), __ccgo_ts+2816, int32(3704), __ccgo_ts+7840)
				}
...
func ts_query_cursor__state_precedes(tls *libc.TLS, self uintptr, a uintptr, b uintptr) (r uint8) {
	...
	a_caps = capture_list_pool_get(tls, self+80, (*QueryState)(unsafe.Pointer(a)).Fcapture_list_id)
	b_caps = capture_list_pool_get(tls, self+80, (*QueryState)(unsafe.Pointer(b)).Fcapture_list_id)
	...
	if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*CaptureList)(unsafe.Pointer(a_caps)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+2816, int32(3755), __ccgo_ts+7879)
	}
	if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*CaptureList)(unsafe.Pointer(b_caps)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__67)), __ccgo_ts+2816, int32(3756), __ccgo_ts+7910)
	}
...
func ts_query_cursor__sort_states_by_capture(tls *libc.TLS, self uintptr) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+2816, int32(3767), __ccgo_ts+7941)
		}
		if libc.BoolInt64(!(i-libc.Uint32FromInt32(1) < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+2816, int32(3767), __ccgo_ts+7972)
		}
		...
		if libc.BoolInt64(!(i < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+2816, int32(3769), __ccgo_ts+7941)
		}
		*(*QueryState)(unsafe.Pointer(bp)) = *(*QueryState)(unsafe.Pointer((*QueryStateList)(unsafe.Pointer(states)).Fcontents + uintptr(i)*24))
		...
		for {
			if libc.BoolInt64(!(j < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+2816, int32(3772), __ccgo_ts+8007)
			}
			if libc.BoolInt64(!(j-libc.Uint32FromInt32(1) < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+2816, int32(3772), __ccgo_ts+8038)
			}
		...
		_3:
			...
			if v2 = j > uint32(0); v2 {
				if libc.BoolInt64(!(j-libc.Uint32FromInt32(1) < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+2816, int32(3774), __ccgo_ts+8038)
				}
			}
		...
		if libc.BoolInt64(!(j < (*QueryStateList)(unsafe.Pointer(states)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__68)), __ccgo_ts+2816, int32(3775), __ccgo_ts+8007)
		}
...
func ts_query_cursor__add_state(tls *libc.TLS, self uintptr, pattern uintptr) {
	...
	if libc.BoolInt64(!(uint32((*PatternEntry)(unsafe.Pointer(pattern)).Fstep_index) < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__69)), __ccgo_ts+2816, int32(3783), __ccgo_ts+8073)
	}
	step = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	for index > uint32(0) {
		if libc.BoolInt64(!(index-libc.Uint32FromInt32(1) < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__69)), __ccgo_ts+2816, int32(3807), __ccgo_ts+8135)
		}
		prev_state = (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents + uintptr(index-uint32(1))*24
	...
	*(*QueryState)(unsafe.Pointer(bp)) = QueryState{
		Fid:                uint32(4294967295),
		Fcapture_list_id:   CAPTURE_LIST_NONE,
		Fheap_insert_order: uint32(4294967295),
	...
	(*QueryStateList)(unsafe.Pointer(self + 40)).Fcontents = _array__splice(tls, (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents, self+40+8, self+40+12, libc.Uint64FromInt64(24), index, uint32(0), uint32(1), bp)
}
...
func ts_query_cursor__prepare_to_capture(tls *libc.TLS, self uintptr, state uintptr, state_index_to_preserve uint32) (r uintptr) {
	...
	if (*QueryState)(unsafe.Pointer(state)).Fcapture_list_id == CAPTURE_LIST_NONE {
		(*QueryState)(unsafe.Pointer(state)).Fcapture_list_id = capture_list_pool_acquire(tls, self+80)
		if (*QueryState)(unsafe.Pointer(state)).Fcapture_list_id == CAPTURE_LIST_NONE {
			...
			if ts_query_cursor__first_in_progress_capture(tls, self, bp, bp+4, bp+8, libc.UintptrFromInt32(0)) != 0 && *(*uint32_t)(unsafe.Pointer(bp)) != state_index_to_preserve {
				if libc.BoolInt64(!(*(*uint32_t)(unsafe.Pointer(bp)) < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__70)), __ccgo_ts+2816, int32(3873), __ccgo_ts+8181)
				}
				...
				list = capture_list_pool_get_mut(tls, self+80, (*QueryState)(unsafe.Pointer(state)).Fcapture_list_id)
	...
	return capture_list_pool_get_mut(tls, self+80, (*QueryState)(unsafe.Pointer(state)).Fcapture_list_id)
}
...
func ts_query_cursor__copy_state(tls *libc.TLS, self uintptr, state_ref uintptr) (r uintptr) {
	...
	state_index = libc.Uint32FromInt64((int64(state) - int64((*TSQueryCursor)(unsafe.Pointer(self)).Fstates.Fcontents)) / 24)
	*(*QueryState)(unsafe.Pointer(bp)) = *(*QueryState)(unsafe.Pointer(state))
	...
	if (*QueryState)(unsafe.Pointer(state)).Fcapture_list_id != CAPTURE_LIST_NONE {
		...
		old_captures = capture_list_pool_get(tls, self+80, (*QueryState)(unsafe.Pointer(state)).Fcapture_list_id)
	...
	(*QueryStateList)(unsafe.Pointer(self + 40)).Fcontents = _array__splice(tls, (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents, self+40+8, self+40+12, libc.Uint64FromInt64(24), state_index+uint32(1), uint32(0), uint32(1), bp)
	if libc.BoolInt64(!(state_index < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__71)), __ccgo_ts+2816, int32(3943), __ccgo_ts+8181)
	}
	*(*uintptr)(unsafe.Pointer(state_ref)) = (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents + uintptr(state_index)*24
	if libc.BoolInt64(!(state_index+libc.Uint32FromInt32(1) < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__71)), __ccgo_ts+2816, int32(3944), __ccgo_ts+8229)
	}
...
func ts_query_cursor__should_descend(tls *libc.TLS, self uintptr, node_intersects_range uint8) (r uint8) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__72)), __ccgo_ts+2816, int32(3959), __ccgo_ts+7643)
		}
		state = (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents + uintptr(i)*24
		if libc.BoolInt64(!(uint32((*QueryState)(unsafe.Pointer(state)).Fstep_index) < (*struct {
			Fcontents uintptr
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__72)), __ccgo_ts+2816, int32(3960), __ccgo_ts+7742)
		}
		next_step = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
	...
	for {
		if (*TSQueryCursor)(unsafe.Pointer(self)).Fhalted != 0 {
			for (*TSQueryCursor)(unsafe.Pointer(self)).Fstates.Fsize > uint32(0) {
				...
				*(*uint32_t)(unsafe.Pointer(v3)) = *(*uint32_t)(unsafe.Pointer(v3)) - 1
				v2 = *(*uint32_t)(unsafe.Pointer(v3))
				state = *(*QueryState)(unsafe.Pointer((*QueryStateList)(unsafe.Pointer(self+40)).Fcontents + uintptr(v2)*24))
				capture_list_pool_release(tls, self+80, state.Fcapture_list_id)
			}
		}
		v3 = self + 208
		...
		if (*TSQueryCursor)(unsafe.Pointer(self)).Fascending != 0 {
			if (*TSQueryCursor)(unsafe.Pointer(self)).Fon_visible_node != 0 {
				...
				for {
					...
					if libc.BoolInt64(!(i < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4078), __ccgo_ts+7643)
					}
					...
					if libc.BoolInt64(!(uint32((*QueryState)(unsafe.Pointer(state1)).Fstep_index) < (*struct {
						...
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4079), __ccgo_ts+7742)
					}
					step = (*struct {
						Fcontents uintptr
						Fsize     uint32_t
					...
					if libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(step)).Fdepth) == libc.Int32FromUint16(PATTERN_DONE_MARKER) && (uint32((*QueryState)(unsafe.Pointer(state1)).Fstart_depth) > (*TSQueryCursor)(unsafe.Pointer(self)).Fdepth || (*TSQueryCursor)(unsafe.Pointer(self)).Fdepth == uint32(0)) {
						...
						if libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(step)).Fdepth) != libc.Int32FromUint16(PATTERN_DONE_MARKER) && uint32((*QueryState)(unsafe.Pointer(state1)).Fstart_depth)+uint32((*QueryStep)(unsafe.Pointer(step)).Fdepth) > (*TSQueryCursor)(unsafe.Pointer(self)).Fdepth {
							capture_list_pool_release(tls, self+80, (*QueryState)(unsafe.Pointer(state1)).Fcapture_list_id)
							deleted_count = deleted_count + 1
						} else {
							if deleted_count > uint32(0) {
								if libc.BoolInt64(!(i-deleted_count < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
									libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4112), __ccgo_ts+8281)
								}
			...
			parent_intersects_range = libc.BoolUint8(v7 || range_intersects(tls, bp, self+128) != 0)
			*(*TSRange)(unsafe.Pointer(bp + 24)) = TSRange{
			...
			node_intersects_range = libc.BoolUint8(parent_intersects_range != 0 && range_intersects(tls, bp+24, self+128) != 0)
			node_intersects_containing_range = range_intersects(tls, bp+24, self+152)
			node_within_containing_range = range_within(tls, bp+24, self+152)
			if node_within_containing_range != 0 && (*TSQueryCursor)(unsafe.Pointer(self)).Fon_visible_node != 0 {
				...
				*(*uint32)(unsafe.Pointer(bp + 72)) = uint32(8)
				...
				if !(node_is_error != 0) {
					...
					for {
						...
						if libc.BoolInt64(!(i1 < (*struct {
							...
							libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4207), __ccgo_ts+8335)
						}
						pattern = (*struct {
							Fcontents uintptr
							Fsize     uint32_t
						...
						if libc.BoolInt64(!(uint32((*PatternEntry)(unsafe.Pointer(pattern)).Fstep_index) < (*struct {
							...
							libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4211), __ccgo_ts+8073)
						}
						step1 = (*struct {
							Fcontents uintptr
							Fsize     uint32_t
				...
				if ts_query__pattern_map_search(tls, (*TSQueryCursor)(unsafe.Pointer(self)).Fquery, symbol, bp+76) != 0 {
					if libc.BoolInt64(!(*(*uint32)(unsafe.Pointer(bp + 76)) < (*struct {
						Fcontents uintptr
						Fsize     uint32_t
						Fcapacity uint32_t
					})(unsafe.Pointer((*TSQueryCursor)(unsafe.Pointer(self)).Fquery+96)).Fsize)) != 0 {
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4229), __ccgo_ts+8335)
					}
					pattern1 = (*struct {
						Fcontents uintptr
						Fsize     uint32_t
					...
					if libc.BoolInt64(!(uint32((*PatternEntry)(unsafe.Pointer(pattern1)).Fstep_index) < (*struct {
						Fcontents uintptr
						Fsize     uint32_t
						Fcapacity uint32_t
					})(unsafe.Pointer((*TSQueryCursor)(unsafe.Pointer(self)).Fquery+80)).Fsize)) != 0 {
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4231), __ccgo_ts+8073)
					}
					step2 = (*struct {
						Fcontents uintptr
						Fsize     uint32_t
					...
					for cond := true; cond; cond = libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(step2)).Fsymbol) == libc.Int32FromUint16(symbol) {
						...
						*(*uint32)(unsafe.Pointer(bp + 76)) = *(*uint32)(unsafe.Pointer(bp + 76)) + 1
						...
						if libc.BoolInt64(!(*(*uint32)(unsafe.Pointer(bp + 76)) < (*struct {
							...
							libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4249), __ccgo_ts+8335)
						}
						pattern1 = (*struct {
							Fcontents uintptr
							Fsize     uint32_t
						...
						if libc.BoolInt64(!(uint32((*PatternEntry)(unsafe.Pointer(pattern1)).Fstep_index) < (*struct {
							...
							libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4250), __ccgo_ts+8073)
						}
						step2 = (*struct {
							Fcontents uintptr
							Fsize     uint32_t
				...
				for {
					...
					if libc.BoolInt64(!(j < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4256), __ccgo_ts+8385)
					}
					*(*uintptr)(unsafe.Pointer(bp + 80)) = (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents + uintptr(j)*24
					if libc.BoolInt64(!(uint32((*QueryState)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 80)))).Fstep_index) < (*struct {
						...
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4257), __ccgo_ts+7742)
					}
					step3 = (*struct {
						Fcontents uintptr
						Fsize     uint32_t
					...
					if (*QueryStep)(unsafe.Pointer(step3)).Fnegated_field_list_id != 0 {
						if libc.BoolInt64(!(uint32((*QueryStep)(unsafe.Pointer(step3)).Fnegated_field_list_id) < (*struct {
							Fcontents uintptr
							Fsize     uint32_t
							Fcapacity uint32_t
						})(unsafe.Pointer((*TSQueryCursor)(unsafe.Pointer(self)).Fquery+160)).Fsize)) != 0 {
							libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4306), __ccgo_ts+8423)
						}
					...
					if !(node_does_match != 0) {
						if !(later_sibling_can_match != 0) {
							capture_list_pool_release(tls, self+80, (*QueryState)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 80)))).Fcapture_list_id)
							_array__erase(tls, (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents, self+40+8, libc.Uint64FromInt64(24), j)
							j = j - 1
						}
						goto _11
					}
					...
					if libc.BoolInt64(!(uint32((*QueryState)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 80)))).Fstep_index) < (*struct {
						...
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4407), __ccgo_ts+7742)
					}
					next_step = (*struct {
						Fcontents uintptr
						Fsize     uint32_t
					...
					for {
						...
						if libc.BoolInt64(!(k1 < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
							libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4433), __ccgo_ts+8502)
						}
						*(*uintptr)(unsafe.Pointer(bp + 88)) = (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents + uintptr(k1)*24
						if libc.BoolInt64(!(uint32((*QueryState)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 88)))).Fstep_index) < (*struct {
							...
							libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4434), __ccgo_ts+8540)
						}
						child_step = (*struct {
							Fcontents uintptr
							Fsize     uint32_t
				...
				for {
					...
					if libc.BoolInt64(!(j1 < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4495), __ccgo_ts+8385)
					}
					...
					if int32(uint8(*(*uint16)(unsafe.Pointer(state3 + 18))&0x4000>>14)) != 0 {
						_array__erase(tls, (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents, self+40+8, libc.Uint64FromInt64(24), j1)
						j1 = j1 - 1
						goto _15
					}
					...
					for {
						...
						if libc.BoolInt64(!(k2 < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
							libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4507), __ccgo_ts+8502)
						}
						...
						state_captures = capture_list_pool_get(tls, self+80, (*QueryState)(unsafe.Pointer(state3)).Fcapture_list_id)
						...
						if v7 = (*CaptureList)(unsafe.Pointer(state_captures)).Fsize > uint32(0) && (*CaptureList)(unsafe.Pointer(other_captures)).Fsize > uint32(0); v7 {
							if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*CaptureList)(unsafe.Pointer(other_captures)).Fsize)) != 0 {
								libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4534), __ccgo_ts+8606)
							}
							if libc.BoolInt64(!((*CaptureList)(unsafe.Pointer(state_captures)).Fsize-libc.Uint32FromInt32(1) < (*CaptureList)(unsafe.Pointer(state_captures)).Fsize)) != 0 {
								libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4535), __ccgo_ts+8645)
							}
						}
						...
						if *(*uint8)(unsafe.Pointer(bp + 96)) != 0 {
							if libc.Int32FromUint16((*QueryState)(unsafe.Pointer(state3)).Fstep_index) == libc.Int32FromUint16((*QueryState)(unsafe.Pointer(other_state)).Fstep_index) && (int32(uint8(*(*uint16)(unsafe.Pointer(other_state + 18))&0x1000>>12)) != 0 || !(int32(uint8(*(*uint16)(unsafe.Pointer(state3 + 18))&0x1000>>12)) != 0)) {
								capture_list_pool_release(tls, self+80, (*QueryState)(unsafe.Pointer(other_state)).Fcapture_list_id)
								_array__erase(tls, (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents, self+40+8, libc.Uint64FromInt64(24), k2)
								k2 = k2 - 1
								goto _16
							}
						...
						if *(*uint8)(unsafe.Pointer(bp + 97)) != 0 {
							if libc.Int32FromUint16((*QueryState)(unsafe.Pointer(state3)).Fstep_index) == libc.Int32FromUint16((*QueryState)(unsafe.Pointer(other_state)).Fstep_index) && (int32(uint8(*(*uint16)(unsafe.Pointer(state3 + 18))&0x1000>>12)) != 0 || !(int32(uint8(*(*uint16)(unsafe.Pointer(other_state + 18))&0x1000>>12)) != 0)) {
								capture_list_pool_release(tls, self+80, (*QueryState)(unsafe.Pointer(state3)).Fcapture_list_id)
								_array__erase(tls, (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents, self+40+8, libc.Uint64FromInt64(24), j1)
								j1 = j1 - 1
					...
					if !(did_remove != 0) {
						if libc.BoolInt64(!(uint32((*QueryState)(unsafe.Pointer(state3)).Fstep_index) < (*struct {
							Fcontents uintptr
							Fsize     uint32_t
							Fcapacity uint32_t
						})(unsafe.Pointer((*TSQueryCursor)(unsafe.Pointer(self)).Fquery+80)).Fsize)) != 0 {
							libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__73)), __ccgo_ts+2816, int32(4595), __ccgo_ts+7742)
						}
						next_step1 = (*struct {
							Fcontents uintptr
							Fsize     uint32_t
						...
						if libc.Int32FromUint16((*QueryStep)(unsafe.Pointer(next_step1)).Fdepth) == libc.Int32FromUint16(PATTERN_DONE_MARKER) {
							if int32(uint8(*(*uint16)(unsafe.Pointer(state3 + 18))&0x2000>>13)) != 0 {
								...
								_array__erase(tls, (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents, self+40+8, libc.Uint64FromInt64(24), libc.Uint32FromInt64((int64(state3)-int64((*TSQueryCursor)(unsafe.Pointer(self)).Fstates.Fcontents))/24))
								did_match = libc.BoolUint8(1 != 0)
								j1 = j1 - 1
							}
						}
...
func ts_query_cursor_next_match(tls *libc.TLS, self uintptr, match uintptr) (r uint8) {
	...
	if (*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states_heap_size > uint32(0) {
		...
		for {
			...
			if libc.BoolInt64(!(i < (*QueryStateList)(unsafe.Pointer(self+56)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__74)), __ccgo_ts+2816, int32(4646), __ccgo_ts+8707)
			}
			...
			if libc.BoolInt64(!(state_index < (*QueryStateList)(unsafe.Pointer(self+56)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__74)), __ccgo_ts+2816, int32(4647), __ccgo_ts+8754)
			}
	...
	if libc.BoolInt64(!(state_index < (*QueryStateList)(unsafe.Pointer(self+56)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__74)), __ccgo_ts+2816, int32(4654), __ccgo_ts+8754)
	}
	...
	captures = capture_list_pool_get(tls, self+80, (*QueryState)(unsafe.Pointer(state1)).Fcapture_list_id)
	...
	capture_list_pool_release(tls, self+80, (*QueryState)(unsafe.Pointer(state1)).Fcapture_list_id)
	if (*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states_heap_size > uint32(0) {
		finished_state_erase(tls, self+56, state_index, self+80)
		(*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states_heap_size = (*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states.Fsize
	} else {
		_array__erase(tls, (*QueryStateList)(unsafe.Pointer(self+56)).Fcontents, self+56+8, libc.Uint64FromInt64(24), state_index)
	}
	return libc.BoolUint8(1 != 0)
}
...
func ts_query_cursor_remove_match(tls *libc.TLS, self uintptr, match_id uint32_t) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*QueryStateList)(unsafe.Pointer(self+56)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__75)), __ccgo_ts+2816, int32(4683), __ccgo_ts+8707)
		}
		state = (*QueryStateList)(unsafe.Pointer(self+56)).Fcontents + uintptr(i)*24
		if (*QueryState)(unsafe.Pointer(state)).Fid == match_id {
			capture_list_pool_release(tls, self+80, (*QueryState)(unsafe.Pointer(state)).Fcapture_list_id)
			if (*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states_heap_size > uint32(0) {
				finished_state_erase(tls, self+56, i, self+80)
				(*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states_heap_size = (*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states.Fsize
			} else {
				_array__erase(tls, (*QueryStateList)(unsafe.Pointer(self+56)).Fcontents, self+56+8, libc.Uint64FromInt64(24), i)
			}
			return
		}
		goto _1
	...
	for {
		...
		if libc.BoolInt64(!(i1 < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__75)), __ccgo_ts+2816, int32(4702), __ccgo_ts+7643)
		}
		state1 = (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents + uintptr(i1)*24
		if (*QueryState)(unsafe.Pointer(state1)).Fid == match_id {
			capture_list_pool_release(tls, self+80, (*QueryState)(unsafe.Pointer(state1)).Fcapture_list_id)
			_array__erase(tls, (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents, self+40+8, libc.Uint64FromInt64(24), i1)
			return
		}
		goto _2
	_2:
		...
		*(*uint8)(unsafe.Pointer(bp + 12)) = libc.BoolUint8(0 != 0)
		...
		for (*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states.Fsize > uint32(0) {
			if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*QueryStateList)(unsafe.Pointer(self+56)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__76)), __ccgo_ts+2816, int32(4746), __ccgo_ts+8811)
			}
			state = (*QueryStateList)(unsafe.Pointer(self + 56)).Fcontents
			captures = capture_list_pool_get(tls, self+80, (*QueryState)(unsafe.Pointer(state)).Fcapture_list_id)
			if libc.Uint32FromInt32(int32(*(*uint16)(unsafe.Pointer(state + 18))&0xfff>>0)) >= (*CaptureList)(unsafe.Pointer(captures)).Fsize {
				capture_list_pool_release(tls, self+80, (*QueryState)(unsafe.Pointer(state)).Fcapture_list_id)
				finished_state_pop(tls, self+56, self+80)
				(*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states_heap_size = (*TSQueryCursor)(unsafe.Pointer(self)).Ffinished_states.Fsize
				continue
			}
			if libc.BoolInt64(!(libc.Uint32FromInt32(int32(*(*uint16)(unsafe.Pointer(state + 18))&0xfff>>0)) < (*CaptureList)(unsafe.Pointer(captures)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__76)), __ccgo_ts+2816, int32(4763), __ccgo_ts+7681)
			}
			node = (*TSQueryCapture)(unsafe.Pointer((*CaptureList)(unsafe.Pointer(captures)).Fcontents + uintptr(int32(*(*uint16)(unsafe.Pointer(state + 18))&0xfff>>0))*40)).Fnode
			...
			if node_outside_of_range != 0 {
				libc.PostIncBitFieldPtr16Uint16(state+18, 1, 12, 0, 0xfff)
				finished_state_sift_down(tls, self+56, uint32(0), self+80)
				continue
			}
			node_start_byte = ts_node_start_byte(tls, node)
		...
		if first_finished_state != 0 {
			...
			if *(*uint8)(unsafe.Pointer(bp + 12)) != 0 {
				if libc.BoolInt64(!(*(*uint32_t)(unsafe.Pointer(bp + 8)) < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__76)), __ccgo_ts+2816, int32(4804), __ccgo_ts+8858)
				}
		...
		if state1 != 0 {
			...
			(*TSQueryMatch)(unsafe.Pointer(match)).Fid = (*QueryState)(unsafe.Pointer(state1)).Fid
			(*TSQueryMatch)(unsafe.Pointer(match)).Fpattern_index = (*QueryState)(unsafe.Pointer(state1)).Fpattern_index
			captures1 = capture_list_pool_get(tls, self+80, (*QueryState)(unsafe.Pointer(state1)).Fcapture_list_id)
		...
		if capture_list_pool_is_empty(tls, self+80) != 0 && found_unfinished_state != 0 {
			if libc.BoolInt64(!(*(*uint32_t)(unsafe.Pointer(bp + 8)) < (*QueryStateList)(unsafe.Pointer(self+40)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__76)), __ccgo_ts+2816, int32(4838), __ccgo_ts+8858)
			}
			...
			_array__erase(tls, (*QueryStateList)(unsafe.Pointer(self+40)).Fcontents, self+40+8, libc.Uint64FromInt64(24), *(*uint32_t)(unsafe.Pointer(bp + 8)))
		}
...
func stack_node_retain(tls *libc.TLS, self uintptr) {
	...
	if libc.BoolInt64(!((*StackNode)(unsafe.Pointer(self)).Fref_count > libc.Uint32FromInt32(0))) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__77)), __ccgo_ts+8923, int32(85), __ccgo_ts+8931)
	}
	(*StackNode)(unsafe.Pointer(self)).Fref_count = (*StackNode)(unsafe.Pointer(self)).Fref_count + 1
	if libc.BoolInt64(!((*StackNode)(unsafe.Pointer(self)).Fref_count != libc.Uint32FromInt32(0))) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__77)), __ccgo_ts+8923, int32(87), __ccgo_ts+8951)
	}
}
...
recur:
	;
	if libc.BoolInt64(!((*StackNode)(unsafe.Pointer(self)).Fref_count != libc.Uint32FromInt32(0))) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__78)), __ccgo_ts+8923, int32(96), __ccgo_ts+8951)
	}
	(*StackNode)(unsafe.Pointer(self)).Fref_count = (*StackNode)(unsafe.Pointer(self)).Fref_count - 1
...
func ts_stack__add_version(tls *libc.TLS, self uintptr, original_version StackVersion, node uintptr) (r StackVersion) {
	...
	if libc.BoolInt64(!(original_version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__79)), __ccgo_ts+8923, int32(293), __ccgo_ts+8972)
	}
	if libc.BoolInt64(!(original_version < (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__79)), __ccgo_ts+8923, int32(294), __ccgo_ts+8972)
	}
...
func ts_stack__add_slice(tls *libc.TLS, self uintptr, original_version StackVersion, node uintptr, subtrees uintptr) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*StackSliceArray)(unsafe.Pointer(self+16)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__80)), __ccgo_ts+8923, int32(311), __ccgo_ts+3349)
		}
		...
		if libc.BoolInt64(!(version < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__80)), __ccgo_ts+8923, int32(312), __ccgo_ts+9024)
		}
...
func stack__iter(tls *libc.TLS, self uintptr, version StackVersion, __ccgo_fp_callback StackCallback, payload uintptr, goal_subtree_count int32) (r StackSliceArray) {
	...
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__81)), __ccgo_ts+8923, int32(334), __ccgo_ts+9024)
	}
	head = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	for (*Stack)(unsafe.Pointer(self)).Fiterators.Fsize > uint32(0) {
		...
		for {
			...
			if libc.BoolInt64(!(i < (*struct {
				...
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+32)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__81)), __ccgo_ts+8923, int32(352), __ccgo_ts+9067)
			}
			iterator = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				...
				if j == uint32((*StackNode)(unsafe.Pointer(node)).Flink_count) {
					*(*StackLink)(unsafe.Pointer(bp + 48)) = *(*StackLink)(unsafe.Pointer(node + 16))
					if libc.BoolInt64(!(i < (*struct {
						...
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__81)), __ccgo_ts+8923, int32(387), __ccgo_ts+9067)
					}
					...
					*(*StackLink)(unsafe.Pointer(bp + 48)) = *(*StackLink)(unsafe.Pointer(node + 16 + uintptr(j)*24))
					if libc.BoolInt64(!(i < (*struct {
						...
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__81)), __ccgo_ts+8923, int32(391), __ccgo_ts+9067)
					}
					...
					*(*StackIterator)(unsafe.Pointer((*struct {
					...
					if libc.BoolInt64(!((*struct {
						...
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__81)), __ccgo_ts+8923, int32(393), __ccgo_ts+9108)
					}
					next_iterator = (*struct {
						Fcontents uintptr
						Fsize     uint32_t
...
func ts_stack_delete(tls *libc.TLS, self uintptr) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__82)), __ccgo_ts+8923, int32(447), __ccgo_ts+9176)
		}
	...
	if (*Stack)(unsafe.Pointer(self)).Fnode_pool.Fcontents != 0 {
		...
		for {
			...
			if libc.BoolInt64(!(i1 < (*StackNodeArray)(unsafe.Pointer(self+48)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__82)), __ccgo_ts+8923, int32(452), __ccgo_ts+9213)
			}
...
func ts_stack_halted_version_count(tls *libc.TLS, self uintptr) (r uint32_t) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__83)), __ccgo_ts+8923, int32(466), __ccgo_ts+9176)
		}
		head = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
...
func ts_stack_state(tls *libc.TLS, self uintptr, version StackVersion) (r TSStateId) {
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__84)), __ccgo_ts+8923, int32(475), __ccgo_ts+9024)
	}
...
func ts_stack_position(tls *libc.TLS, self uintptr, version StackVersion) (r Length) {
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__85)), __ccgo_ts+8923, int32(479), __ccgo_ts+9024)
	}
	return (*StackNode)(unsafe.Pointer((*StackHead)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_last_external_token(tls *libc.TLS, self uintptr, version StackVersion) (r Subtree) {
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__86)), __ccgo_ts+8923, int32(483), __ccgo_ts+9024)
	}
...
func ts_stack_set_last_external_token(tls *libc.TLS, self uintptr, version StackVersion, _token Subtree) {
	...
	*(*Subtree)(unsafe.Pointer(bp)) = _token
	...
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__87)), __ccgo_ts+8923, int32(487), __ccgo_ts+9024)
	}
	head = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_error_cost(tls *libc.TLS, self uintptr, version StackVersion) (r uint32) {
	...
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__88)), __ccgo_ts+8923, int32(494), __ccgo_ts+9024)
	}
	head = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_node_count_since_error(tls *libc.TLS, self uintptr, version StackVersion) (r uint32) {
	...
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__89)), __ccgo_ts+8923, int32(505), __ccgo_ts+9024)
	}
	head = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_push(tls *libc.TLS, self uintptr, version StackVersion, _subtree Subtree, pending uint8, state TSStateId) {
	...
	*(*Subtree)(unsafe.Pointer(bp)) = _subtree
	...
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__90)), __ccgo_ts+8923, int32(519), __ccgo_ts+9024)
	}
	head = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_pop_pending(tls *libc.TLS, self uintptr, version StackVersion) (r StackSliceArray) {
	...
	*(*StackSliceArray)(unsafe.Pointer(bp)) = stack__iter(tls, self, version, __ccgo_fp(pop_pending_callback), libc.UintptrFromInt32(0), 0)
	if (*(*StackSliceArray)(unsafe.Pointer(bp))).Fsize > uint32(0) {
		if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*StackSliceArray)(unsafe.Pointer(bp)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__91)), __ccgo_ts+8923, int32(555), __ccgo_ts+1934)
		}
		...
		if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*StackSliceArray)(unsafe.Pointer(bp)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__91)), __ccgo_ts+8923, int32(556), __ccgo_ts+1934)
		}
	...
	if (*StackIterator)(unsafe.Pointer(iterator)).Fsubtrees.Fsize > uint32(0) {
		...
		if v1 = !(*(*uint8)(unsafe.Pointer(found_error)) != 0); v1 {
			if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*SubtreeArray)(unsafe.Pointer(iterator+8)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__92)), __ccgo_ts+8923, int32(564), __ccgo_ts+9254)
			}
		}
...
func ts_stack_pop_error(tls *libc.TLS, self uintptr, version StackVersion) (r SubtreeArray) {
	...
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__93)), __ccgo_ts+8923, int32(576), __ccgo_ts+9024)
	}
		...
		if *(*uintptr)(unsafe.Pointer(node + 16 + uintptr(i)*24 + 8)) != 0 && ts_subtree_is_error(tls, (*(*StackLink)(unsafe.Pointer(node + 16 + uintptr(i)*24))).Fsubtree) != 0 {
			...
			*(*StackSliceArray)(unsafe.Pointer(bp + 8)) = stack__iter(tls, self, version, __ccgo_fp(pop_error_callback), bp, int32(1))
			if (*(*StackSliceArray)(unsafe.Pointer(bp + 8))).Fsize > uint32(0) {
				if libc.BoolInt64(!((*(*StackSliceArray)(unsafe.Pointer(bp + 8))).Fsize == libc.Uint32FromInt32(1))) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__93)), __ccgo_ts+8923, int32(582), __ccgo_ts+9298)
				}
				if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*StackSliceArray)(unsafe.Pointer(bp+8)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__93)), __ccgo_ts+8923, int32(583), __ccgo_ts+1934)
				}
				...
				if libc.BoolInt64(!(libc.Uint32FromInt32(libc.Int32FromInt32(0)) < (*StackSliceArray)(unsafe.Pointer(bp+8)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__93)), __ccgo_ts+8923, int32(584), __ccgo_ts+1934)
				}
...
func summarize_stack_callback(tls *libc.TLS, payload uintptr, iterator uintptr) (r StackAction) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*StackSummary)(unsafe.Pointer((*SummarizeStackSession)(unsafe.Pointer(session)).Fsummary)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__94)), __ccgo_ts+8923, int32(612), __ccgo_ts+9312)
		}
...
func ts_stack_record_summary(tls *libc.TLS, self uintptr, version StackVersion, max_depth uint32) {
	...
	*(*SummarizeStackSession)(unsafe.Pointer(bp)) = SummarizeStackSession{
	...
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__95)), __ccgo_ts+8923, int32(631), __ccgo_ts+9024)
	}
	head = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_get_summary(tls *libc.TLS, self uintptr, version StackVersion) (r uintptr) {
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__96)), __ccgo_ts+8923, int32(640), __ccgo_ts+9024)
	}
	return (*StackHead)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_dynamic_precedence(tls *libc.TLS, self uintptr, version StackVersion) (r int32) {
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__97)), __ccgo_ts+8923, int32(644), __ccgo_ts+9024)
	}
	return (*StackNode)(unsafe.Pointer((*StackHead)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_has_advanced_since_error(tls *libc.TLS, self uintptr, version StackVersion) (r uint8) {
	...
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__98)), __ccgo_ts+8923, int32(648), __ccgo_ts+9024)
	}
	head = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_remove_version(tls *libc.TLS, self uintptr, version StackVersion) {
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__99)), __ccgo_ts+8923, int32(672), __ccgo_ts+9024)
	}
	stack_head_delete(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_renumber_version(tls *libc.TLS, self uintptr, v1 StackVersion, v2 StackVersion) {
	...
	if libc.BoolInt64(!(v2 < v1)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__100)), __ccgo_ts+8923, int32(678), __ccgo_ts+9353)
	}
	if libc.BoolInt64(!(v1 < (*Stack)(unsafe.Pointer(self)).Fheads.Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__100)), __ccgo_ts+8923, int32(679), __ccgo_ts+9361)
	}
	if libc.BoolInt64(!(v1 < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__100)), __ccgo_ts+8923, int32(680), __ccgo_ts+9393)
	}
	source_head = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	if libc.BoolInt64(!(v2 < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__100)), __ccgo_ts+8923, int32(681), __ccgo_ts+9431)
	}
	target_head = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_swap_versions(tls *libc.TLS, self uintptr, v1 StackVersion, v2 StackVersion) {
	...
	if libc.BoolInt64(!(v1 < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__101)), __ccgo_ts+8923, int32(692), __ccgo_ts+9393)
	}
	...
	if libc.BoolInt64(!(v1 < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__101)), __ccgo_ts+8923, int32(693), __ccgo_ts+9393)
	}
	if libc.BoolInt64(!(v2 < (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__101)), __ccgo_ts+8923, int32(693), __ccgo_ts+9431)
	}
	*(*StackHead)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	if libc.BoolInt64(!(v2 < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__101)), __ccgo_ts+8923, int32(694), __ccgo_ts+9431)
	}
	*(*StackHead)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_copy_version(tls *libc.TLS, self uintptr, version StackVersion) (r StackVersion) {
	...
	if libc.BoolInt64(!(version < (*Stack)(unsafe.Pointer(self)).Fheads.Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__102)), __ccgo_ts+8923, int32(698), __ccgo_ts+9469)
	}
	if libc.BoolInt64(!(version < (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__102)), __ccgo_ts+8923, int32(699), __ccgo_ts+9024)
	}
	...
	*(*StackHead)(unsafe.Pointer((*struct {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__102)), __ccgo_ts+8923, int32(701), __ccgo_ts+9496)
	}
	head = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_merge(tls *libc.TLS, self uintptr, version1 StackVersion, version2 StackVersion) (r uint8) {
	...
	if libc.BoolInt64(!(version1 < (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__103)), __ccgo_ts+8923, int32(710), __ccgo_ts+9556)
	}
	head1 = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	if libc.BoolInt64(!(version2 < (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__103)), __ccgo_ts+8923, int32(711), __ccgo_ts+9600)
	}
	head2 = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_can_merge(tls *libc.TLS, self uintptr, version1 StackVersion, version2 StackVersion) (r uint8) {
	...
	if libc.BoolInt64(!(version1 < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__104)), __ccgo_ts+8923, int32(723), __ccgo_ts+9556)
	}
	head1 = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	if libc.BoolInt64(!(version2 < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__104)), __ccgo_ts+8923, int32(724), __ccgo_ts+9600)
	}
	head2 = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_halt(tls *libc.TLS, self uintptr, version StackVersion) {
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__105)), __ccgo_ts+8923, int32(735), __ccgo_ts+9024)
	}
	(*StackHead)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_pause(tls *libc.TLS, self uintptr, version StackVersion, lookahead Subtree) {
	...
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__106)), __ccgo_ts+8923, int32(739), __ccgo_ts+9024)
	}
	head = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_is_active(tls *libc.TLS, self uintptr, version StackVersion) (r uint8) {
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__107)), __ccgo_ts+8923, int32(746), __ccgo_ts+9024)
	}
...
func ts_stack_is_halted(tls *libc.TLS, self uintptr, version StackVersion) (r uint8) {
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__108)), __ccgo_ts+8923, int32(750), __ccgo_ts+9024)
	}
	return libc.BoolUint8((*StackHead)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_is_paused(tls *libc.TLS, self uintptr, version StackVersion) (r uint8) {
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__109)), __ccgo_ts+8923, int32(754), __ccgo_ts+9024)
	}
	return libc.BoolUint8((*StackHead)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_stack_resume(tls *libc.TLS, self uintptr, version StackVersion) (r Subtree) {
	...
	if libc.BoolInt64(!(version < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__110)), __ccgo_ts+8923, int32(758), __ccgo_ts+9024)
	}
	head = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	if libc.BoolInt64(!((*StackHead)(unsafe.Pointer(head)).Fstatus == int32(StackStatusPaused))) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__110)), __ccgo_ts+8923, int32(759), __ccgo_ts+9644)
	}
...
func ts_stack_clear(tls *libc.TLS, self uintptr) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__111)), __ccgo_ts+8923, int32(769), __ccgo_ts+9176)
		}
		stack_head_delete(tls, (*struct {
			Fcontents uintptr
			Fsize     uint32_t
...
func ts_stack_print_dot_graph(tls *libc.TLS, self uintptr, language uintptr, f uintptr) (r uint8) {
	...
	libc.Xfprintf(tls, f, __ccgo_ts+9678, 0)
	libc.Xfprintf(tls, f, __ccgo_ts+9695, 0)
	libc.Xfprintf(tls, f, __ccgo_ts+9710, 0)
	*(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__112)), __ccgo_ts+8923, int32(792), __ccgo_ts+9176)
		}
		head = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		libc.Xfprintf(tls, f, __ccgo_ts+9733, libc.VaList(bp+48, i))
		libc.Xfprintf(tls, f, __ccgo_ts+9770, libc.VaList(bp+48, i, (*StackHead)(unsafe.Pointer(head)).Fnode))
		if (*StackHead)(unsafe.Pointer(head)).Fstatus == int32(StackStatusPaused) {
			libc.Xfprintf(tls, f, __ccgo_ts+9796, 0)
		}
		libc.Xfprintf(tls, f, __ccgo_ts+9807, libc.VaList(bp+48, i, ts_stack_node_count_since_error(tls, self, i), ts_stack_error_cost(tls, self, i)))
		if (*StackHead)(unsafe.Pointer(head)).Fsummary != 0 {
			libc.Xfprintf(tls, f, __ccgo_ts+9891, 0)
			j = uint32(0)
			for {
				...
				if libc.BoolInt64(!(j < (*StackSummary)(unsafe.Pointer((*StackHead)(unsafe.Pointer(head)).Fsummary)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__112)), __ccgo_ts+8923, int32(810), __ccgo_ts+9901)
				}
				libc.Xfprintf(tls, f, __ccgo_ts+9939, libc.VaList(bp+48, libc.Int32FromUint16((*StackSummaryEntry)(unsafe.Pointer((*StackSummary)(unsafe.Pointer((*StackHead)(unsafe.Pointer(head)).Fsummary)).Fcontents+uintptr(j)*20)).Fstate)))
				goto _2
			_2:
				;
				j = j + 1
		...
		if *(*uintptr)(unsafe.Pointer(head + 24)) != 0 {
			...
			libc.Xfprintf(tls, f, __ccgo_ts+9943, 0)
			j1 = uint32(0)
			for {
				if !(j1 < (*ExternalScannerState)(unsafe.Pointer(state)).Flength) {
					break
				}
				libc.Xfprintf(tls, f, __ccgo_ts+9968, libc.VaList(bp+48, int32(*(*int8)(unsafe.Pointer(data + uintptr(j1))))))
				goto _3
			_3:
				;
				j1 = j1 + 1
		...
		libc.Xfprintf(tls, f, __ccgo_ts+9973, 0)
		(*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
	...
	for !(all_iterators_done != 0) {
		...
		for {
			...
			if libc.BoolInt64(!(i1 < (*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__112)), __ccgo_ts+8923, int32(831), __ccgo_ts+9067)
			}
			...
			for {
				...
				if libc.BoolInt64(!(j2 < (*struct {
					Fcontents uintptr
					Fsize     uint32_t
					Fcapacity uint32_t
				})(unsafe.Pointer(bp)).Fsize)) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__112)), __ccgo_ts+8923, int32(835), __ccgo_ts+9977)
				}
			...
			all_iterators_done = libc.BoolUint8(0 != 0)
			libc.Xfprintf(tls, f, __ccgo_ts+10016, libc.VaList(bp+48, node))
			if libc.Int32FromUint16((*StackNode)(unsafe.Pointer(node)).Fstate) == 0 {
				libc.Xfprintf(tls, f, __ccgo_ts+10026, 0)
			} else {
				if libc.Int32FromUint16((*StackNode)(unsafe.Pointer(node)).Flink_count) == int32(1) && *(*uintptr)(unsafe.Pointer(node + 16 + 8)) != 0 && ts_subtree_extra(tls, (*(*StackLink)(unsafe.Pointer(node + 16))).Fsubtree) != 0 {
					libc.Xfprintf(tls, f, __ccgo_ts+10036, 0)
				} else {
					libc.Xfprintf(tls, f, __ccgo_ts+10066, libc.VaList(bp+48, libc.Int32FromUint16((*StackNode)(unsafe.Pointer(node)).Fstate)))
				}
			}
			libc.Xfprintf(tls, f, __ccgo_ts+10077, libc.VaList(bp+48, (*StackNode)(unsafe.Pointer(node)).Fposition.Fextent.Frow+uint32(1), (*StackNode)(unsafe.Pointer(node)).Fposition.Fextent.Fcolumn, (*StackNode)(unsafe.Pointer(node)).Fnode_count, (*StackNode)(unsafe.Pointer(node)).Ferror_cost, (*StackNode)(unsafe.Pointer(node)).Fdynamic_precedence))
			j3 = 0
			for {
				...
				*(*struct {
				...
				libc.Xfprintf(tls, f, __ccgo_ts+10159, libc.VaList(bp+48, node, (*(*StackLink)(unsafe.Pointer(bp + 16))).Fnode))
				if (*(*StackLink)(unsafe.Pointer(bp + 16))).Fis_pending != 0 {
					libc.Xfprintf(tls, f, __ccgo_ts+10180, 0)
				}
				if *(*uintptr)(unsafe.Pointer(bp + 16 + 8)) != 0 && ts_subtree_extra(tls, (*(*StackLink)(unsafe.Pointer(bp + 16))).Fsubtree) != 0 {
					libc.Xfprintf(tls, f, __ccgo_ts+10194, 0)
				}
				if !(*(*uintptr)(unsafe.Pointer(bp + 16 + 8)) != 0) {
					libc.Xfprintf(tls, f, __ccgo_ts+10210, 0)
				} else {
					libc.Xfprintf(tls, f, __ccgo_ts+10220, 0)
					...
					if quoted != 0 {
						libc.Xfprintf(tls, f, __ccgo_ts+10228, 0)
					}
					ts_language_write_symbol_as_dot_string(tls, language, f, ts_subtree_symbol(tls, (*(*StackLink)(unsafe.Pointer(bp + 16))).Fsubtree))
					if quoted != 0 {
						libc.Xfprintf(tls, f, __ccgo_ts+10228, 0)
					}
					libc.Xfprintf(tls, f, __ccgo_ts+10230, 0)
					libc.Xfprintf(tls, f, __ccgo_ts+10232, libc.VaList(bp+48, ts_subtree_error_cost(tls, (*(*StackLink)(unsafe.Pointer(bp + 16))).Fsubtree), ts_subtree_dynamic_precedence(tls, (*(*StackLink)(unsafe.Pointer(bp + 16))).Fsubtree)))
				}
				libc.Xfprintf(tls, f, __ccgo_ts+10285, 0)
				if j3 == 0 {
					if libc.BoolInt64(!(i1 < (*struct {
						Fcontents uintptr
						Fsize     uint32_t
						...
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__112)), __ccgo_ts+8923, int32(894), __ccgo_ts+9067)
					}
					next_iterator = (*struct {
						Fcontents uintptr
						Fsize     uint32_t
					...
					*(*StackIterator)(unsafe.Pointer((*struct {
					...
					if libc.BoolInt64(!((*struct {
						...
						libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__112)), __ccgo_ts+8923, int32(897), __ccgo_ts+9108)
					}
					next_iterator = (*struct {
						Fcontents uintptr
						Fsize     uint32_t
	...
	libc.Xfprintf(tls, f, __ccgo_ts+10289, 0)
	if (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
...
func ts_external_scanner_state_init(tls *libc.TLS, self uintptr, data uintptr, length uint32) {
	...
	if uint64(length) > uint64(24) {
		...
		libc.X__builtin___memcpy_chk(tls, (*ExternalScannerState)(unsafe.Pointer(self)).F__ccgo0_0.Flong_data, data, uint64(length), ^__predefined_size_t(0))
	} else {
		libc.X__builtin___memcpy_chk(tls, self, data, uint64(length), ^__predefined_size_t(0))
	}
}
...
func ts_external_scanner_state_copy(tls *libc.TLS, self uintptr) (r ExternalScannerState) {
	...
	if uint64((*ExternalScannerState)(unsafe.Pointer(self)).Flength) > uint64(24) {
		...
		libc.X__builtin___memcpy_chk(tls, result.F__ccgo0_0.Flong_data, (*ExternalScannerState)(unsafe.Pointer(self)).F__ccgo0_0.Flong_data, uint64((*ExternalScannerState)(unsafe.Pointer(self)).Flength), ^__predefined_size_t(0))
	}
	return result
}
...
func ts_subtree_array_copy(tls *libc.TLS, self SubtreeArray, dest uintptr) {
	...
	if self.Fcapacity > uint32(0) {
		...
		libc.X__builtin___memcpy_chk(tls, (*SubtreeArray)(unsafe.Pointer(dest)).Fcontents, self.Fcontents, uint64(self.Fsize)*uint64(8), ^__predefined_size_t(0))
		i = uint32(0)
		for {
			if !(i < self.Fsize) {
				break
			...
			if libc.BoolInt64(!(i < (*SubtreeArray)(unsafe.Pointer(dest)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__113)), __ccgo_ts+10292, int32(76), __ccgo_ts+10302)
			}
...
func ts_subtree_array_clear(tls *libc.TLS, pool uintptr, self uintptr) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*SubtreeArray)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__114)), __ccgo_ts+10292, int32(83), __ccgo_ts+268)
		}
...
func ts_subtree_array_remove_trailing_extras(tls *libc.TLS, self uintptr, destination uintptr) {
	...
	for (*SubtreeArray)(unsafe.Pointer(self)).Fsize > uint32(0) {
		if libc.BoolInt64(!((*SubtreeArray)(unsafe.Pointer(self)).Fsize-libc.Uint32FromInt32(1) < (*SubtreeArray)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__115)), __ccgo_ts+10292, int32(99), __ccgo_ts+10331)
		}
...
func ts_subtree_array_reverse(tls *libc.TLS, self uintptr) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*SubtreeArray)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__116)), __ccgo_ts+10292, int32(113), __ccgo_ts+268)
		}
		swap = *(*Subtree)(unsafe.Pointer((*SubtreeArray)(unsafe.Pointer(self)).Fcontents + uintptr(i)*8))
		if libc.BoolInt64(!(i < (*SubtreeArray)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__116)), __ccgo_ts+10292, int32(114), __ccgo_ts+268)
		}
		if libc.BoolInt64(!(uint32(reverse_index) < (*SubtreeArray)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__116)), __ccgo_ts+10292, int32(114), __ccgo_ts+10373)
		}
		*(*Subtree)(unsafe.Pointer((*SubtreeArray)(unsafe.Pointer(self)).Fcontents + uintptr(i)*8)) = *(*Subtree)(unsafe.Pointer((*SubtreeArray)(unsafe.Pointer(self)).Fcontents + uintptr(reverse_index)*8))
		if libc.BoolInt64(!(uint32(reverse_index) < (*SubtreeArray)(unsafe.Pointer(self)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__116)), __ccgo_ts+10292, int32(115), __ccgo_ts+10373)
		}
	...
	if (*SubtreePool)(unsafe.Pointer(self)).Ffree_trees.Fcontents != 0 {
		...
		for {
			...
			if libc.BoolInt64(!(i < (*MutableSubtreeArray)(unsafe.Pointer(self)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__117)), __ccgo_ts+10292, int32(130), __ccgo_ts+10414)
			}
...
func ts_subtree_can_inline(tls *libc.TLS, padding Length, size Length, lookahead_bytes uint32_t) (r uint8) {
	return libc.BoolUint8(padding.Fbytes < uint32(255) && padding.Fextent.Frow < uint32(16) && padding.Fextent.Fcolumn < uint32(255) && size.Fbytes < uint32(255) && size.Fextent.Frow == uint32(0) && size.Fextent.Fcolumn < uint32(255) && lookahead_bytes < uint32(16))
}
...
func ts_subtree_set_symbol(tls *libc.TLS, self uintptr, symbol TSSymbol, language uintptr) {
	...
	metadata = ts_language_symbol_metadata(tls, language, symbol)
	if int32(*(*uint8)(unsafe.Pointer(self + 0))&0x1>>0) != 0 {
		if libc.BoolInt64(!(libc.Int32FromUint16(symbol) < libc.Int32FromInt32(255))) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__118)), __ccgo_ts+10292, int32(233), __ccgo_ts+10456)
		}
...
func ts_subtree_clone(tls *libc.TLS, _self Subtree) (r MutableSubtree) {
	...
	*(*Subtree)(unsafe.Pointer(bp)) = _self
	...
	old_children = v1
	libc.X__builtin___memcpy_chk(tls, new_children, old_children, alloc_size, ^__predefined_size_t(0))
...
func ts_subtree_summarize_children(tls *libc.TLS, _self MutableSubtree, language uintptr) {
	...
	*(*MutableSubtree)(unsafe.Pointer(bp)) = _self
	...
	if libc.BoolInt64(!!(int32(*(*uint8)(unsafe.Pointer(bp + 0))&0x1>>0) != 0)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__119)), __ccgo_ts+10292, int32(343), __ccgo_ts+10469)
	}
	...
	for {
		...
		*(*uint32_t)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp)) + 56)) += ts_subtree_visible_descendant_count(tls, *(*Subtree)(unsafe.Pointer(bp + 8)))
		...
		if ts_subtree_is_error(tls, *(*Subtree)(unsafe.Pointer(bp + 8))) != 0 {
			...
			(*SubtreeHeapData)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp)))).Fparse_state = libc.Uint16FromInt32(libc.Int32FromInt32(32767)*libc.Int32FromInt32(2) + libc.Int32FromInt32(1))
		}
...
func ts_subtree_retain(tls *libc.TLS, _self Subtree) {
	...
	*(*Subtree)(unsafe.Pointer(bp)) = _self
	...
	if libc.BoolInt64(!(libc.AtomicLoadPUint32(*(*uintptr)(unsafe.Pointer(bp))) > libc.Uint32FromInt32(0))) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__120)), __ccgo_ts+10292, int32(560), __ccgo_ts+10490)
	}
	atomic_inc(tls, *(*uintptr)(unsafe.Pointer(bp)))
	if libc.BoolInt64(!(libc.AtomicLoadPUint32(*(*uintptr)(unsafe.Pointer(bp))) != libc.Uint32FromInt32(0))) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__120)), __ccgo_ts+10292, int32(562), __ccgo_ts+10514)
	}
}
...
func ts_subtree_release(tls *libc.TLS, pool uintptr, _self Subtree) {
	...
	*(*Subtree)(unsafe.Pointer(bp)) = _self
	...
	if libc.BoolInt64(!(libc.AtomicLoadPUint32(*(*uintptr)(unsafe.Pointer(bp))) > libc.Uint32FromInt32(0))) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__121)), __ccgo_ts+10292, int32(569), __ccgo_ts+10490)
	}
			...
			for {
				...
				*(*struct {
				...
				if libc.BoolInt64(!(libc.AtomicLoadPUint32(*(*uintptr)(unsafe.Pointer(bp + 16))) > libc.Uint32FromInt32(0))) != 0 {
					libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__121)), __ccgo_ts+10292, int32(581), __ccgo_ts+10539)
				}
...
func ts_subtree__write_char_to_string(tls *libc.TLS, str uintptr, n size_t, chr int32_t) (r size_t) {
	...
	defer tls.Free(16)
	if chr == -int32(1) {
		return libc.Uint64FromInt32(libc.X__builtin___snprintf_chk(tls, str, n, 0, ^__predefined_size_t(0), __ccgo_ts+10564, 0))
	} else {
		if chr == int32('\000') {
			return libc.Uint64FromInt32(libc.X__builtin___snprintf_chk(tls, str, n, 0, ^__predefined_size_t(0), __ccgo_ts+10572, 0))
		} else {
			if chr == int32('\n') {
				return libc.Uint64FromInt32(libc.X__builtin___snprintf_chk(tls, str, n, 0, ^__predefined_size_t(0), __ccgo_ts+10577, 0))
			} else {
				if chr == int32('\t') {
					return libc.Uint64FromInt32(libc.X__builtin___snprintf_chk(tls, str, n, 0, ^__predefined_size_t(0), __ccgo_ts+10582, 0))
				} else {
					if chr == int32('\r') {
						return libc.Uint64FromInt32(libc.X__builtin___snprintf_chk(tls, str, n, 0, ^__predefined_size_t(0), __ccgo_ts+10587, 0))
					} else {
						if 0 < chr && chr < int32(128) && isprint(tls, chr) != 0 {
							return libc.Uint64FromInt32(libc.X__builtin___snprintf_chk(tls, str, n, 0, ^__predefined_size_t(0), __ccgo_ts+10592, libc.VaList(bp+8, chr)))
						} else {
							return libc.Uint64FromInt32(libc.X__builtin___snprintf_chk(tls, str, n, 0, ^__predefined_size_t(0), __ccgo_ts+10597, libc.VaList(bp+8, chr)))
						}
					}
				}
			}
...
var ROOT_FIELD = __ccgo_ts + 10600
...
func ts_subtree__write_to_string(tls *libc.TLS, self Subtree, _string uintptr, limit size_t, language uintptr, include_all uint8, root_alias_symbol TSSymbol, root_alias_is_named uint8, root_field_name uintptr) (r size_t) {
	...
	*(*uintptr)(unsafe.Pointer(bp)) = _string
	...
	var v2 uint32_t
	var v7 bool
	var _ /* cursor at bp+8 */ uintptr
	var _ /* node at bp+32 */ Subtree
	var _ /* stack at bp+16 */ struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	}
	...
	*(*struct {
	...
	(*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(bp + 16)).Fcontents = _array__grow(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(bp+16)).Fcontents, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(bp+16)).Fsize, bp+16+12, uint32(1), libc.Uint64FromInt64(64))
	v1 = bp + 16 + 8
	...
	*(*WriteToStringFrame)(unsafe.Pointer((*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(bp+16)).Fcontents + uintptr(v2)*64)) = WriteToStringFrame{
		Fsubtree:        self,
	...
	for (*(*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(bp + 16))).Fsize != 0 {
		if libc.BoolInt64(!((*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(bp+16)).Fsize-libc.Uint32FromInt32(1) < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(bp+16)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__122)), __ccgo_ts+10292, int32(855), __ccgo_ts+10609)
		}
		frame = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(bp+16)).Fcontents + uintptr((*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(bp+16)).Fsize-uint32(1))*64
		*(*Subtree)(unsafe.Pointer(bp + 32)) = Subtree{}
		*(*struct {
			Fptr  [0]uintptr
			Fdata SubtreeInlineData
		})(unsafe.Pointer(bp + 32)) = (*WriteToStringFrame)(unsafe.Pointer(frame)).Fsubtree
		if !(*(*uintptr)(unsafe.Pointer(bp + 32)) != 0) {
			if !((*WriteToStringFrame)(unsafe.Pointer(frame)).Fis_root != 0) {
				*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(libc.X__builtin___snprintf_chk(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, 0, ^__predefined_size_t(0), __ccgo_ts+10657, 0))
				if (*WriteToStringFrame)(unsafe.Pointer(frame)).Ffield_name != 0 {
					*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(libc.X__builtin___snprintf_chk(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, 0, ^__predefined_size_t(0), __ccgo_ts+10659, libc.VaList(bp+48, (*WriteToStringFrame)(unsafe.Pointer(frame)).Ffield_name)))
				}
			}
			*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(libc.X__builtin___snprintf_chk(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, 0, ^__predefined_size_t(0), __ccgo_ts+10664, 0))
			v1 = bp + 16 + 8
			*(*uint32_t)(unsafe.Pointer(v1)) = *(*uint32_t)(unsafe.Pointer(v1)) - 1
			v2 = *(*uint32_t)(unsafe.Pointer(v1))
			_ = *(*WriteToStringFrame)(unsafe.Pointer((*struct {
				...
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(bp+16)).Fcontents + uintptr(v2)*64))
			continue
		}
		if !((*WriteToStringFrame)(unsafe.Pointer(frame)).Fpre_written != 0) {
			if v7 = include_all != 0 || ts_subtree_missing(tls, *(*Subtree)(unsafe.Pointer(bp + 32))) != 0; !v7 {
				if (*WriteToStringFrame)(unsafe.Pointer(frame)).Falias_symbol != 0 {
					...
					v6 = libc.BoolInt32(ts_subtree_visible(tls, *(*Subtree)(unsafe.Pointer(bp + 32))) != 0 && ts_subtree_named(tls, *(*Subtree)(unsafe.Pointer(bp + 32))) != 0)
				}
			}
			...
			if is_visible != 0 {
				...
				if ts_subtree_is_error(tls, *(*Subtree)(unsafe.Pointer(bp + 32))) != 0 && ts_subtree_child_count(tls, *(*Subtree)(unsafe.Pointer(bp + 32))) == uint32(0) && (*SubtreeHeapData)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 32)))).Fsize.Fbytes > uint32(0) {
					*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(libc.X__builtin___snprintf_chk(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, 0, ^__predefined_size_t(0), __ccgo_ts+10671, 0))
					*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(ts_subtree__write_char_to_string(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, *(*int32_t)(unsafe.Add(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 32))), 48))))
				} else {
					if (*WriteToStringFrame)(unsafe.Pointer(frame)).Falias_symbol != 0 {
						v6 = libc.Int32FromUint16((*WriteToStringFrame)(unsafe.Pointer(frame)).Falias_symbol)
					} else {
						v6 = libc.Int32FromUint16(ts_subtree_symbol(tls, *(*Subtree)(unsafe.Pointer(bp + 32))))
					}
					symbol = libc.Uint16FromInt32(v6)
					symbol_name = ts_language_symbol_name(tls, language, symbol)
					if ts_subtree_missing(tls, *(*Subtree)(unsafe.Pointer(bp + 32))) != 0 {
						*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(libc.X__builtin___snprintf_chk(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, 0, ^__predefined_size_t(0), __ccgo_ts+10684, 0))
						if (*WriteToStringFrame)(unsafe.Pointer(frame)).Falias_is_named != 0 || ts_subtree_named(tls, *(*Subtree)(unsafe.Pointer(bp + 32))) != 0 {
							*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(libc.X__builtin___snprintf_chk(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, 0, ^__predefined_size_t(0), __ccgo_ts+10694, libc.VaList(bp+48, symbol_name)))
						} else {
							*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(libc.X__builtin___snprintf_chk(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, 0, ^__predefined_size_t(0), __ccgo_ts+10697, libc.VaList(bp+48, symbol_name)))
						}
					} else {
						*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(libc.X__builtin___snprintf_chk(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, 0, ^__predefined_size_t(0), __ccgo_ts+10702, libc.VaList(bp+48, symbol_name)))
					}
				}
			} else {
				if (*WriteToStringFrame)(unsafe.Pointer(frame)).Fis_root != 0 {
					...
					if ts_subtree_child_count(tls, *(*Subtree)(unsafe.Pointer(bp + 32))) > uint32(0) {
						*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(libc.X__builtin___snprintf_chk(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, 0, ^__predefined_size_t(0), __ccgo_ts+10702, libc.VaList(bp+48, symbol_name1)))
					} else {
						if ts_subtree_named(tls, *(*Subtree)(unsafe.Pointer(bp + 32))) != 0 {
							*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(libc.X__builtin___snprintf_chk(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, 0, ^__predefined_size_t(0), __ccgo_ts+10706, libc.VaList(bp+48, symbol_name1)))
						} else {
							*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(libc.X__builtin___snprintf_chk(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, 0, ^__predefined_size_t(0), __ccgo_ts+10711, libc.VaList(bp+48, symbol_name1)))
						}
					}
				}
			}
			if ts_subtree_child_count(tls, *(*Subtree)(unsafe.Pointer(bp + 32))) != 0 {
				(*WriteToStringFrame)(unsafe.Pointer(frame)).Falias_sequence = ts_language_alias_sequence(tls, language, uint32((*SubtreeHeapData)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 32)))).F__ccgo19_48.F__ccgo0_0.Fproduction_id))
				ts_language_field_map(tls, language, uint32((*SubtreeHeapData)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 32)))).F__ccgo19_48.F__ccgo0_0.Fproduction_id), frame+48, frame+56)
			}
		...
		if (*WriteToStringFrame)(unsafe.Pointer(frame)).Fchild_index < ts_subtree_child_count(tls, *(*Subtree)(unsafe.Pointer(bp + 32))) {
			if int32(*(*uint8)(unsafe.Pointer(bp + 32 + 0))&0x1>>0) != 0 {
				v1 = libc.UintptrFromInt32(0)
			} else {
				v1 = *(*uintptr)(unsafe.Pointer(bp + 32)) - uintptr((*SubtreeHeapData)(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(bp + 32)))).Fchild_count)*8
			}
			...
			*(*uint8)(unsafe.Add(unsafe.Pointer(&child_frame), 24)) = libc.BoolUint8(0 != 0)
			if ts_subtree_extra(tls, child) != 0 {
			} else {
			...
			*(*WriteToStringFrame)(unsafe.Pointer((*struct {
				...
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(bp+16)).Fcontents + uintptr(v2)*64)) = child_frame
			continue
		}
		if (*WriteToStringFrame)(unsafe.Pointer(frame)).Fis_visible != 0 {
			*(*uintptr)(unsafe.Pointer(bp + 8)) = *(*uintptr)(unsafe.Pointer(bp + 8)) + uintptr(libc.X__builtin___snprintf_chk(tls, *(*uintptr)(unsafe.Pointer(writer)), limit, 0, ^__predefined_size_t(0), __ccgo_ts+10718, 0))
		}
		v1 = bp + 16 + 8
		*(*uint32_t)(unsafe.Pointer(v1)) = *(*uint32_t)(unsafe.Pointer(v1)) - 1
		v2 = *(*uint32_t)(unsafe.Pointer(v1))
	...
	if (*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(bp+16)).Fcontents != 0 {
		(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{ts_current_free})))(tls, (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(bp+16)).Fcontents)
	}
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(bp + 16)).Fcontents = libc.UintptrFromInt32(0)
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(bp + 16)).Fsize = uint32(0)
	(*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(bp + 16)).Fcapacity = uint32(0)
	return libc.Uint64FromInt64(int64(*(*uintptr)(unsafe.Pointer(bp + 8))) - int64(*(*uintptr)(unsafe.Pointer(bp))))
}
...
func ts_subtree__print_dot_graph(tls *libc.TLS, self uintptr, start_offset uint32_t, language uintptr, alias_symbol TSSymbol, f uintptr) {
	...
	libc.Xfprintf(tls, f, __ccgo_ts+10720, libc.VaList(bp+8, self))
	...
	if ts_subtree_is_error(tls, *(*Subtree)(unsafe.Pointer(self))) != 0 && ts_subtree_child_count(tls, *(*Subtree)(unsafe.Pointer(self))) == uint32(0) && *(*int32_t)(unsafe.Add(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(self))), 48)) != 0 {
		libc.Xfprintf(tls, f, __ccgo_ts+10945, libc.VaList(bp+8, *(*int32_t)(unsafe.Add(unsafe.Pointer(*(*uintptr)(unsafe.Pointer(self))), 48))))
	}
	libc.Xfprintf(tls, f, __ccgo_ts+9973, 0)
	...
	for {
		...
		libc.Xfprintf(tls, f, __ccgo_ts+10962, libc.VaList(bp+8, self, child, i))
...
func ts_subtree_print_dot_graph(tls *libc.TLS, _self Subtree, language uintptr, f uintptr) {
	...
	defer tls.Free(16)
	*(*Subtree)(unsafe.Pointer(bp)) = _self
	libc.Xfprintf(tls, f, __ccgo_ts+10995, 0)
	libc.Xfprintf(tls, f, __ccgo_ts+9710, 0)
...
func ts_tree_cursor_is_entry_visible(tls *libc.TLS, self uintptr, index uint32_t) (r uint8) {
	...
	if libc.BoolInt64(!(index < (*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__123)), __ccgo_ts+11011, int32(24), __ccgo_ts+11025)
	}
	entry = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	if index == uint32(0) || ts_subtree_visible(tls, *(*Subtree)(unsafe.Pointer((*TreeCursorEntry)(unsafe.Pointer(entry)).Fsubtree))) != 0 {
		...
		if !(ts_subtree_extra(tls, *(*Subtree)(unsafe.Pointer((*TreeCursorEntry)(unsafe.Pointer(entry)).Fsubtree))) != 0) {
			if libc.BoolInt64(!(index-libc.Uint32FromInt32(1) < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+8)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__123)), __ccgo_ts+11011, int32(28), __ccgo_ts+11066)
			}
			parent_entry = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
...
func ts_tree_cursor_iterate_children(tls *libc.TLS, self uintptr) (r CursorChildIterator) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__124)), __ccgo_ts+11011, int32(40), __ccgo_ts+137)
	}
	last_entry = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_tree_cursor_new(tls *libc.TLS, node TSNode) (r TSTreeCursor) {
	...
	var _ /* self at bp+32 */ TSTreeCursor
	*(*TreeCursor)(unsafe.Pointer(bp)) = TreeCursor{}
	ts_tree_cursor_init(tls, bp, node)
	*(*TSTreeCursor)(unsafe.Pointer(bp + 32)) = TSTreeCursor{}
	libc.X__builtin___memcpy_chk(tls, bp+32, bp, uint64(32), ^__predefined_size_t(0))
	return *(*TSTreeCursor)(unsafe.Pointer(bp + 32))
}
...
func ts_tree_cursor_goto_previous_sibling_internal(tls *libc.TLS, _self uintptr) (r TreeCursorStep) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__125)), __ccgo_ts+11011, int32(380), __ccgo_ts+137)
	}
	...
	if libc.BoolInt64(!((*TreeCursor)(unsafe.Pointer(self)).Fstack.Fsize-libc.Uint32FromInt32(2) < (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(self+8)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__125)), __ccgo_ts+11011, int32(384), __ccgo_ts+11111)
	}
	parent = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__125)), __ccgo_ts+11011, int32(386), __ccgo_ts+137)
	}
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__125)), __ccgo_ts+11011, int32(398), __ccgo_ts+137)
	}
	(*TreeCursorEntry)(unsafe.Pointer((*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_tree_cursor_goto_descendant(tls *libc.TLS, _self uintptr, goal_descendant_index uint32_t) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__126)), __ccgo_ts+11011, int32(435), __ccgo_ts+11167)
		}
		entry = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
...
func ts_tree_cursor_current_descendant_index(tls *libc.TLS, _self uintptr) (r uint32_t) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__127)), __ccgo_ts+11011, int32(479), __ccgo_ts+137)
	}
	last_entry = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
...
func ts_tree_cursor_current_node(tls *libc.TLS, _self uintptr) (r TSNode) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__128)), __ccgo_ts+11011, int32(485), __ccgo_ts+137)
	}
	last_entry = (*struct {
		Fcontents uintptr
		Fsize     uint32_t
	...
	if (*TreeCursor)(unsafe.Pointer(self)).Fstack.Fsize > uint32(1) && !(is_extra != 0) {
		if libc.BoolInt64(!((*TreeCursor)(unsafe.Pointer(self)).Fstack.Fsize-libc.Uint32FromInt32(2) < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__128)), __ccgo_ts+11011, int32(489), __ccgo_ts+11111)
		}
		parent_entry = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
	...
	*(*uint8)(unsafe.Pointer(can_have_later_siblings_with_this_field)) = libc.BoolUint8(0 != 0)
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__129)), __ccgo_ts+11011, int32(526), __ccgo_ts+11167)
		}
		entry = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		if libc.BoolInt64(!(i-libc.Uint32FromInt32(1) < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__129)), __ccgo_ts+11011, int32(527), __ccgo_ts+11204)
		}
		parent_entry = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
...
func ts_tree_cursor_parent_node(tls *libc.TLS, _self uintptr) (r TSNode) {
	...
	for {
		...
		if libc.BoolInt64(!(libc.Uint32FromInt32(i) < (*struct {
			Fcontents uintptr
			Fsize     uint32_t
			Fcapacity uint32_t
		})(unsafe.Pointer(self+8)).Fsize)) != 0 {
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__130)), __ccgo_ts+11011, int32(640), __ccgo_ts+11167)
		}
		entry = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		alias_symbol = uint16(0)
		if i > 0 {
			if libc.BoolInt64(!(libc.Uint32FromInt32(i-libc.Int32FromInt32(1)) < (*struct {
				Fcontents uintptr
				Fsize     uint32_t
				Fcapacity uint32_t
			})(unsafe.Pointer(self+8)).Fsize)) != 0 {
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__130)), __ccgo_ts+11011, int32(644), __ccgo_ts+11204)
			}
			parent_entry = (*struct {
				Fcontents uintptr
				Fsize     uint32_t
...
func ts_tree_cursor_current_field_id(tls *libc.TLS, _self uintptr) (r TSFieldId) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__131)), __ccgo_ts+11011, int32(669), __ccgo_ts+11167)
		}
		entry = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
		...
		if libc.BoolInt64(!(i-libc.Uint32FromInt32(1) < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__131)), __ccgo_ts+11011, int32(670), __ccgo_ts+11204)
		}
		parent_entry = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
...
func ts_tree_cursor_copy(tls *libc.TLS, _cursor uintptr) (r TSTreeCursor) {
	...
	var _ /* res at bp+32 */ TSTreeCursor
	_ = cursor
	cursor = _cursor
	*(*TreeCursor)(unsafe.Pointer(bp)) = TreeCursor{}
	...
	(*struct {
		...
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(bp + 8)).Fcontents = _array__splice(tls, (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(bp+8)).Fcontents, bp+8+8, bp+8+12, libc.Uint64FromInt64(32), (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
	})(unsafe.Pointer(bp+8)).Fsize, uint32(0), (*struct {
		Fcontents uintptr
		Fsize     uint32_t
		Fcapacity uint32_t
...
func ts_tree_new(tls *libc.TLS, root Subtree, language uintptr, included_ranges uintptr, included_range_count uint32) (r uintptr) {
	...
	libc.X__builtin___memcpy_chk(tls, (*TSTree)(unsafe.Pointer(result)).Fincluded_ranges, included_ranges, uint64(included_range_count)*uint64(24), ^__predefined_size_t(0))
...
func ts_tree_included_ranges(tls *libc.TLS, self uintptr, length uintptr) (r uintptr) {
	...
	*(*uint32_t)(unsafe.Pointer(length)) = (*TSTree)(unsafe.Pointer(self)).Fincluded_range_count
	...
	libc.X__builtin___memcpy_chk(tls, ranges, (*TSTree)(unsafe.Pointer(self)).Fincluded_ranges, uint64((*TSTree)(unsafe.Pointer(self)).Fincluded_range_count)*uint64(24), ^__predefined_size_t(0))
	return ranges
}
...
func __darwin_check_fd_set(tls *libc.TLS, _a int32, _b uintptr) (r int32) {
	if uint64(0) != libc.Uint64FromInt32(0) {
		return 1
	} else {
		return int32(1)
	}
...
func __darwin_fd_isset(tls *libc.TLS, _fd int32, _p uintptr) (r int32) {
	if __darwin_check_fd_set(tls, _fd, _p) != 0 {
		return *(*__int32_t)(unsafe.Pointer(_p + uintptr(libc.Uint64FromInt32(_fd)/(libc.Uint64FromInt64(4)*libc.Uint64FromInt32(8)))*4)) & libc.Int32FromUint64(libc.Uint64FromInt32(1)<<(libc.Uint64FromInt32(_fd)%(libc.Uint64FromInt64(4)*libc.Uint64FromInt32(8))))
	}
	return 0
}

func __darwin_fd_set(tls *libc.TLS, _fd int32, _p uintptr) {
	if __darwin_check_fd_set(tls, _fd, _p) != 0 {
		*(*__int32_t)(unsafe.Pointer(_p + uintptr(libc.Uint64FromInt32(_fd)/(libc.Uint64FromInt64(4)*libc.Uint64FromInt32(8)))*4)) |= libc.Int32FromUint64(libc.Uint64FromInt32(1) << (libc.Uint64FromInt32(_fd) % (libc.Uint64FromInt64(4) * libc.Uint64FromInt32(8))))
	}
}

func __darwin_fd_clr(tls *libc.TLS, _fd int32, _p uintptr) {
	if __darwin_check_fd_set(tls, _fd, _p) != 0 {
		*(*__int32_t)(unsafe.Pointer(_p + uintptr(libc.Uint64FromInt32(_fd)/(libc.Uint64FromInt64(4)*libc.Uint64FromInt32(8)))*4)) &= ^libc.Int32FromUint64(libc.Uint64FromInt32(1) << (libc.Uint64FromInt32(_fd) % (libc.Uint64FromInt64(4) * libc.Uint64FromInt32(8))))
	}
}
...
func ts_tree_print_dot_graph(tls *libc.TLS, self uintptr, file_descriptor int32) {
	var file uintptr
	_ = file
	file = libc.Xfdopen(tls, _ts_dup(tls, file_descriptor), __ccgo_ts+2493)
