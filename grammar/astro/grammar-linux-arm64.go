// Code generated for linux/arm64 by 'ccgo -ignore-unsupported-alignment -ignore-unsupported-atomic-sizes -ignore-vector-functions preprocessed.c -o grammar.go', DO NOT EDIT.
...
func _array__splice(tls *libc.TLS, self uintptr, element_size size_t, index uint32_t, old_count uint32_t, new_count uint32_t, elements uintptr) {
	...
	_ = libc.Uint64FromInt64(4)
	{
		if !(old_end <= (*Array)(unsafe.Pointer(self)).Fsize) {
			libc.X__assert_fail(tls, __ccgo_ts+73, __ccgo_ts+19, int32(225), uintptr(unsafe.Pointer(&__func__1)))
		}
	}
...
func scan_raw_text(tls *libc.TLS, scanner uintptr, lexer uintptr) (r uint8) {
	...
	_ = libc.Uint64FromInt64(4)
	{
		if !((*struct {
			...
			libc.X__assert_fail(tls, __ccgo_ts+100, __ccgo_ts+164, int32(315), uintptr(unsafe.Pointer(&__func__2)))
		}
	}
	...
	if (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize == uint32(0) {
		...
		_ = libc.Uint64FromInt64(4)
		{
			if !((*struct {
				...
				libc.X__assert_fail(tls, __ccgo_ts+100, __ccgo_ts+164, int32(343), uintptr(unsafe.Pointer(&__func__3)))
			}
		}
		v1 = (*struct {
			Fcontents uintptr
		...
		if v2 = (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize > uint32(0); v2 {
			_ = libc.Uint64FromInt64(4)
			{
				if !((*struct {
					...
					libc.X__assert_fail(tls, __ccgo_ts+100, __ccgo_ts+164, int32(367), uintptr(unsafe.Pointer(&__func__3)))
				}
			}
		}
			...
			if v1 = (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize > uint32(0); v1 {
				_ = libc.Uint64FromInt64(4)
				{
					if !((*struct {
						...
						libc.X__assert_fail(tls, __ccgo_ts+100, __ccgo_ts+164, int32(437), uintptr(unsafe.Pointer(&__func__4)))
					}
				}
			}
	...
	if v1 = (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize > uint32(0); v1 {
		_ = libc.Uint64FromInt64(4)
		{
			if !((*struct {
				...
				libc.X__assert_fail(tls, __ccgo_ts+100, __ccgo_ts+164, int32(452), uintptr(unsafe.Pointer(&__func__4)))
			}
		}
	}
		...
		if v3 = *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(HTML_INTERPOLATION_END))) != 0 && (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize > uint32(0); v3 {
			_ = libc.Uint64FromInt64(4)
			{
				if !((*struct {
					...
					libc.X__assert_fail(tls, __ccgo_ts+100, __ccgo_ts+164, int32(650), uintptr(unsafe.Pointer(&__func__5)))
				}
			}
		}
