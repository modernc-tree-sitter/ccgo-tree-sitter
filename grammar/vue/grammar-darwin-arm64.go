...
func _array__erase(tls *libc.TLS, self uintptr, element_size size_t, index uint32_t) {
	...
	if libc.BoolInt64(!(index < (*Array)(unsafe.Pointer(self)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__)), __ccgo_ts, int32(175), __ccgo_ts+8)
	}
...
func _array__splice(tls *libc.TLS, self uintptr, element_size size_t, index uint32_t, old_count uint32_t, new_count uint32_t, elements uintptr) {
	...
	if libc.BoolInt64(!(old_end <= (*Array)(unsafe.Pointer(self)).Fsize)) != 0 {
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__1)), __ccgo_ts, int32(226), __ccgo_ts+27)
	}
...
func scan_tag_name(tls *libc.TLS, lexer uintptr) (r String) {
	...
	*(*String)(unsafe.Pointer(bp)) = String{}
	for iswalnum(tls, (*TSLexer)(unsafe.Pointer(lexer)).Flookahead) != 0 || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('-') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32(':') {
		...
		*(*int8)(unsafe.Pointer((*String)(unsafe.Pointer(bp)).Fcontents + uintptr(v1))) = int8(towupper(tls, (*TSLexer)(unsafe.Pointer(lexer)).Flookahead))
		advance(tls, lexer)
	}
...
func scan_raw_text(tls *libc.TLS, scanner uintptr, lexer uintptr) (r uint8) {
	...
	if libc.BoolInt64(!((*struct {
		...
		libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__2)), __ccgo_ts+49, int32(165), __ccgo_ts+60)
	}
	...
	for (*TSLexer)(unsafe.Pointer(lexer)).Flookahead != 0 {
		if towupper(tls, (*TSLexer)(unsafe.Pointer(lexer)).Flookahead) == int32(*(*int8)(unsafe.Pointer(end_delimiter + uintptr(delimiter_index)))) {
...
func scan_implicit_end_tag(tls *libc.TLS, scanner uintptr, lexer uintptr) (r uint8) {
	...
	if (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize == uint32(0) {
		...
		if libc.BoolInt64(!((*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__3)), __ccgo_ts+49, int32(192), __ccgo_ts+60)
		}
		v1 = (*struct {
			Fcontents uintptr
			Fsize     uint32_t
	...
	if is_closing_tag != 0 {
		if v2 = (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize > uint32(0); v2 {
			if libc.BoolInt64(!((*struct {
				...
				libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__3)), __ccgo_ts+49, int32(216), __ccgo_ts+60)
			}
		}
	...
	*(*Tag)(unsafe.Pointer(bp + 16)) = tag_for_name(tls, *(*String)(unsafe.Pointer(bp)))
	if v1 = (*Scanner)(unsafe.Pointer(scanner)).Ftags.Fsize > uint32(0); v1 {
		if libc.BoolInt64(!((*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__4)), __ccgo_ts+49, int32(281), __ccgo_ts+60)
		}
	}
	...
	if !(is_error_recovery != 0) && (*TSLexer)(unsafe.Pointer(lexer)).Flookahead != int32('<') && (*(*uint8)(unsafe.Pointer(valid_symbols + uintptr(TEXT_FRAGMENT))) != 0 || *(*uint8)(unsafe.Pointer(valid_symbols + uintptr(INTERPOLATION_TEXT))) != 0) {
		...
		for !((*(*func(*libc.TLS, uintptr) uint8)(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Feof})))(tls, lexer) != 0) {
			...
			case int32('<'):
				(*(*func(*libc.TLS, uintptr))(unsafe.Pointer(&struct{ uintptr }{(*TSLexer)(unsafe.Pointer(lexer)).Fmark_end})))(tls, lexer)
				advance(tls, lexer)
				if iswalpha(tls, (*TSLexer)(unsafe.Pointer(lexer)).Flookahead) != 0 || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('!') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('?') || (*TSLexer)(unsafe.Pointer(lexer)).Flookahead == int32('/') {
					goto loop_exit
				}
...
func tree_sitter_vue_external_scanner_destroy(tls *libc.TLS, payload uintptr) {
	...
	for {
		...
		if libc.BoolInt64(!(i < (*struct {
			...
			libc.X__assert_rtn(tls, uintptr(unsafe.Pointer(&__func__5)), __ccgo_ts+49, int32(465), __ccgo_ts+141)
		}
		tag_free(tls, (*struct {
			Fcontents uintptr
			Fsize     uint32_t
...
var __func__5 = [41]int8{'t', 'r', 'e', 'e', '_', 's', 'i', 't', 't', 'e', 'r', '_', 'v', 'u', 'e', '_', 'e', 'x', 't', 'e', 'r', 'n', 'a', 'l', '_', 's', 'c', 'a', 'n', 'n', 'e', 'r', '_', 'd', 'e', 's', 't', 'r', 'o', 'y'}
