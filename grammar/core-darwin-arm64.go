// Code generated for darwin/arm64 by 'ccgo -ignore-unsupported-alignment -ignore-unsupported-atomic-sizes -ignore-vector-functions core_complete.c -o core.go', DO NOT EDIT.
...
func OSReadSwapInt16(tls *libc.TLS, _base uintptr, _offset uintptr_t) (r uint16_t) {
	return _OSSwapInt16(tls, libc.AtomicLoadPUint16(uintptr(uint64(_base)+_offset)))
}

func OSReadSwapInt32(tls *libc.TLS, _base uintptr, _offset uintptr_t) (r uint32_t) {
	return _OSSwapInt32(tls, libc.AtomicLoadPUint32(uintptr(uint64(_base)+_offset)))
}

func OSReadSwapInt64(tls *libc.TLS, _base uintptr, _offset uintptr_t) (r uint64_t) {
	return _OSSwapInt64(tls, libc.AtomicLoadPUint64(uintptr(uint64(_base)+_offset)))
}

func OSWriteSwapInt16(tls *libc.TLS, _base uintptr, _offset uintptr_t, _data uint16_t) {
	libc.AtomicStorePUint16(uintptr(uint64(_base)+_offset), _OSSwapInt16(tls, _data))
}

func OSWriteSwapInt32(tls *libc.TLS, _base uintptr, _offset uintptr_t, _data uint32_t) {
	libc.AtomicStorePUint32(uintptr(uint64(_base)+_offset), _OSSwapInt32(tls, _data))
}

func OSWriteSwapInt64(tls *libc.TLS, _base uintptr, _offset uintptr_t, _data uint64_t) {
	libc.AtomicStorePUint64(uintptr(uint64(_base)+_offset), _OSSwapInt64(tls, _data))
}
